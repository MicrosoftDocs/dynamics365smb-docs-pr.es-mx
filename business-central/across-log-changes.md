...
El seguimiento de cambios puede afectar al rendimiento, lo que puede demandarle tiempo, además de aumentar el tamaño de la base de datos, lo que podría costarle dinero. Para reducir esos costos, considere lo siguiente:
