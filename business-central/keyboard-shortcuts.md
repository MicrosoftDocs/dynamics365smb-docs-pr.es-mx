...
# <a name="keyboard-shortcuts"></a><a name="keyboard-shortcuts"></a><a name="keyboard-shortcuts"></a>Accesos directos de teclado
...
|*<kbd>Mayús</kbd>+<kbd>Ctrl</kbd>+<kbd>F</kbd>*|Envíe las líneas sugeridas en la página de hojas de cálculo de flujo de caja.|No aplicable.|
...
|*<kbd>Mayús</kbd>+<kbd>Ctrl</kbd>+<kbd>F9</kbd>*|Registre, imprima y ubique la recepción de almacén.|
...
|--------------------------------|----------|-------|
|<kbd>Entrar</kbd>|Confirmar el valor en el campo actual y pasar al siguiente campo de entrada rápida.||
...
|<kbd>Entrar</kbd>|Seleccionar la fecha enfocada.|
