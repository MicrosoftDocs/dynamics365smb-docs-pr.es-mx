...
|Escriba|Habilite o acceda al elemento o control que tiene el enfoque.|   
...
|Escriba<br />(Fn+flecha abajo)|Abre el registro asociado a este campo.|Abre el registro.| Solo es relevante si una página de ficha está asociada con el registro.|
...
|Escriba|Seleccionar la fecha enfocada.|
