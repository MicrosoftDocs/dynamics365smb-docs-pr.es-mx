...
2. [!INCLUDE[d365fin](includes/d365fin_md.md)] comprueba si se aplican acuerdos de precio/descuento a la información del documento o línea de diario. Luego inserta el precio unitario correspondiente y el porcentaje de descuento de línea utilizando los siguientes criterios:
