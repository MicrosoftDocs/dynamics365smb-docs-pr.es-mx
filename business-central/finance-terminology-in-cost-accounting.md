...
ms.author: edupont
---
# <a name="terminology-in-cost-accounting"></a><a name="terminology-in-cost-accounting"></a><a name="terminology-in-cost-accounting"></a>Terminología en contabilidad de costos

Este tema define los términos clave que se utilizan en contabilidad de costos.  

## <a name="key-terms"></a><a name="key-terms"></a><a name="key-terms"></a>Términos clave
