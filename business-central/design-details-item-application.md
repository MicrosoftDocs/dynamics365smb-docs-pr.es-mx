...
## <a name="inventory-increase"></a><a name="inventory-increase"></a><a name="inventory-increase"></a>Entrada de inventario
...
## <a name="inventory-decrease"></a><a name="inventory-decrease"></a><a name="inventory-decrease"></a>Salida de inventario
...
### <a name="example--fixed-application-with-average-cost"></a><a name="example--fixed-application-with-average-cost"></a><a name="example--fixed-application-with-average-cost"></a>Ejemplo: Liquidación fija con costo promedio
...
### <a name="example--standard-costing-method"></a><a name="example--standard-costing-method"></a><a name="example--standard-costing-method"></a>Ejemplo: Método de costo Estándar
