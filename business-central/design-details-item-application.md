...
## <a name="inventory-increase" />Entrada de inventario
...
## <a name="inventory-decrease" />Salida de inventario
...
### <a name="example--fixed-application-with-average-cost" />Ejemplo: Liquidación fija con costo promedio
...
### <a name="example--standard-costing-method" />Ejemplo: Método de costo Estándar
