...
4. En el campo **Id. objeto para ejecutar** , seleccione 296, **Reg. lotes pedidos venta** .
   ...
   * 498 **Reg. lotes de notas de crédito de compra**
   * 6665 **Reg. lotes pedidos devolución**
   * 298 **Reg. lotes de notas de crédito de venta**
