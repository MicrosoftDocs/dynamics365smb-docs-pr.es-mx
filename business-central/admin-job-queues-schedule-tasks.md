...
El apartado **Mi cola de proyecto** del área de tareas muestra los movimientos de colas de proyectos que se han iniciado, pero que no han finalizado. De manera predeterminada, el apartado no se muestra, pero puede agregarlo en el Área de tareas. Para obtener más información sobre personalización, vaya a [Personalizar el área de trabajo](ui-personalization-user.md).  
