...
### <a name="selling-customized-assembly-items"></a><a name="selling-customized-assembly-items"></a><a name="selling-customized-assembly-items"></a>Vender productos de ensamblado personalizados
...
### <a name="planning-for-assembly-items"></a><a name="planning-for-assembly-items"></a><a name="planning-for-assembly-items"></a>Planificar para los productos de ensamblado
...
### <a name="shipping-assembly-items-from-stock-and-assembled-to-order"></a><a name="shipping-assembly-items-from-stock-and-assembled-to-order"></a><a name="shipping-assembly-items-from-stock-and-assembled-to-order"></a>Enviar productos de ensamblado, desde el inventario y ensamblado para pedido
...
## <a name="roles"></a><a name="roles"></a><a name="roles"></a>Acciones
...
El 23 de enero, Susana, la responsable del procesamiento de pedidos de venta recibe un pedido de La Tienda Aparatos de tres unidades del kit B, que es un producto ATO. Las tres unidades se personalizan y deben incluir la tarjeta gráfica de gran potencia y un bloque de RAM adicional. Las unidades de disco se actualizan a DWD porque las unidades de CD no están disponibles. Susan sabe que las unidades se pueden ensamblar inmediatamente, y deja la fecha de envío sugerida del 23 de enero.  

Al mismo tiempo, el cliente solicita quince unidades del kit A con una solicitud especial; que cinco unidades se personalicen para incluir la tarjeta gráfica de gran potencia. Aunque el equipo A suele ser un producto de tipo ensamblar para stock, la responsable del procesamiento de pedidos combina las cantidades de línea de venta para vender diez unidades desde las existencias y ensamblar cinco unidades personalizadas en el pedido. Las diez unidades del kit A no están disponibles y deben suministrarse primero al inventario mediante una orden de ensamblado según la política de ensamblado del producto. Susana aprende del departamento de ensamblado qué las unidades del kit A no se pueden completar durante la semana actual. Susan fija la fecha de envío de la segunda línea de la orden de venta, para la cantidad combinada de ATO e inventario, en el 27 de enero y notifica al cliente que las 15 unidades del kit A se enviarán cuatro días después que las tres unidades del kit B. Para señalar al departamento de envío que esta orden de venta requiere procesamiento de ensamblado, Susan crea el documento de envío de almacén a partir de la orden de venta.  
...
Juan, el encargado de picking, recupera los componentes para todas las cantidades ATO en el documento de remisión de almacén y los lleva al área de ensamblado. John especifica la cantidad a manejar y registra la recogida de almacén.  

Linda ensambla las tres unidades ATO del kit B. Los componentes ya se han preparado, pero Linda no registra las cantidades de salida y consumo, ni registra la orden, porque ambas acciones se realizan automáticamente a través de las líneas de envío de almacén relacionadas.  
...
### <a name="creating-the-assembly-items"></a><a name="creating-the-assembly-items"></a><a name="creating-the-assembly-items"></a>Crear productos de ensamblado
...
### <a name="selling-the-assembly-items"></a><a name="selling-the-assembly-items"></a><a name="selling-the-assembly-items"></a>Vender productos de ensamblado
...
17. Seleccione la acción **Crear remisión alm.**  
...
8.  Vuelva a abrir la página **Remisión almacén**.  
...
14. Seleccione la acción **Registrar remisión** y, a continuación, el botón **Enviar**.  
...
4.  En la página **Lín. envío almacén ensamblar para pedido**, en el campo **Cdad. a enviar**, especifique **5** y, a continuación cierre la página.  
    ...
    Observe en la página **Pedido de ensamblado** que los campos **Cantidad a ensamblar** y **Cantidad a consumir** ahora se rellenaron con las cantidades de salida y consumo que se registrarán con la remisión.  
...
8.  Vuelva a abrir la página **Remisión almacén**.  
    ...
    En la página **Remisión almacén**, en la línea de diez unidades del kit A, observe que los campos **Ctdad. a enviar** y **Cdad. preparada pedido** ahora contienen el valor **10**.  

9. Seleccione la acción **Registrar remisión** y, a continuación, elija **Enviar**.  
