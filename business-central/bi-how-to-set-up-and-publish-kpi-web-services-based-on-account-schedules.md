...
description: Este tema describe cómo mostrar los datos de KPI de informes financieros según informes financieros específicos.
author: brentholtorf
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
...
> [!NOTE]
> Cuando utiliza este servicio web, las fechas de cierre no se incluyen en su conjunto de datos. Luego puede usar filtros en Power BI para analizar varios períodos de tiempo.
...
3. En la ficha desplegable **Informes financieros**, rellene los campos.
...
7. Para publicar el servicio Web KPI de informes financieros, elija la acción **Publicar servicio Web**. El servicio web se agrega a la lista de servicios web publicados en la página **Servicios web**.
