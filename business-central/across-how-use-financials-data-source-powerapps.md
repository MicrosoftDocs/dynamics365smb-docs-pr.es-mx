...
> [!TIP]  
> La documentación adicional de Power Apps y nuestras muestras de Power App presentadas durante el Evento de lanzamiento de [!INCLUDE[prod_short](includes/prod_short.md)] se publicarán aquí más adelante en la ola 1 de 2023. Obtenga más información en [Comenzar con más plantillas de Power Automate de ejemplo y Power Apps](/dynamics365/release-plan/2023wave1/smb/dynamics365-business-central/get-started-more-sample-power-automate-templates-power-apps).
