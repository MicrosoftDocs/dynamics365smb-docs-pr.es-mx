...
|[Ejemplo: seguimiento de existencias antiguas o expiradas](#example-track-expiring-or-old-stock) | Obtenga una descripción general de los artículos de su inventario que han estado en stock durante mucho tiempo y no se venden bien. | [Movs. productos](https://businesscentral.dynamics.com/?page=38) | **Año de fecha de registro**, **Mes de fecha de contabilización**, **N.º producto**, **Fecha de registro**, **Tipo movimiento**, **Cantidad** y **Cantidad pendiente**. |
