...
## <a name="overview-of-the-steps-to-get-started"></a>Resumen de los pasos para empezar
...
* Intercambie información sobre sus configuraciones de empresas vinculadas. Cada socio puede obtener esta información en **Config. empresas vinculadas**, **Acciones**, **Detalles de conexión**.
...
1. Elija el icono ![Bombilla que abre la función Dígame.](media/ui-search/search_small.png "Dígame qué desea hacer") escriba **Tarjeta de aplicación de Microsoft Entra** y, a continuación, elija el vínculo relacionado.  
...
### <a name="import-or-export-an-intercompany-chart-of-accounts"></a>Importar o exportar el catálogo de cuentas de empresas vinculadas
...
## <a name="map-the-intercompany-chart-of-accounts-to-your-companys-chart-of-accounts"></a>Asignar el catálogo de cuentas de empresas vinculadas al catálogo de cuentas de la empresa propia
...
## <a name="set-up-intercompany-general-journal-templates-and-batches"></a>Configurar libros y lotes de diario general de empresas vinculadas
