...
Si el catálogo de cuentas de su compañía define los planes de empresas vinculadas para sus compañías asociadas, siga el proceso descrito en [Configurar el catálogo de cuentas definido para empresas vinculadas](intercompany-how-setup.md#to-set-up-the-defining-intercompany-chart-of-accounts).  
