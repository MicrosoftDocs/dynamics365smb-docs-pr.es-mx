...
Si el catálogo de cuentas de su compañía define los catálogos de cuentas de empresas vinculadas para sus compañías asociadas, siga el proceso descrito en [Configurar la definición de las empresas vinculadas](intercompany-how-setup.md#to-set-up-the-intercompany-chart-of-accounts).  
