---
title: 'Procedimientos recomendados de configuración: políticas de reorden | Microsoft Docs'
description: 'El campo Política reorden, que se encuentra en las fichas de producto, ofrece cuatro métodos de planificación distintos que determinan la forma en que interactúan los parámetros individuales de planificación.'
author: brentholtorf
ms.author: bholtorf
...
---
# <a name="setup-best-practices-reordering-policies"></a>Procedimientos recomendados de configuración: directivas de reorden

El campo **Política reorden** en las fichas de producto tiene métodos de planificación distintos que determinan la forma en que interactúan los parámetros individuales de planificación.  
