...
ms.author: edupont
---
# <a name="unsubscribe-or-remove-" />Cancelar la suscripción o quitar [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="removing--from-your-app-launcher" />Eliminar [!INCLUDE[prod_short](includes/prod_short.md)] de su lanzador de aplicaciones
