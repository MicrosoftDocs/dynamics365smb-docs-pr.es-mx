...
# <a name="set-up-pricing-and-additional-costs-for-services" />Configurar precios y costos adicionales de servicios
...
## <a name="to-set-up-additional-costs-for-services" />Para configurar costos adicionales de servicios
...
### <a name="to-set-up-service-costs" />Para configurar costos de servicio
...
### <a name="to-specify-a-default-cost-for-service-orders" />Para especificar un costo predeterminado de los pedidos de servicio
