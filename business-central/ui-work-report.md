...
ms.author: jswymer
---
# <a name="run-and-print-reports" />Ejecutar e imprimir informes
...
## <a name="specifying-the-data-to-include-in-a-report" />Especificación de los datos que se van a incluir en un informe
...
## <a name="previewing-a-report" />Vista preliminar de un informe
...
### <a name="work-with-the-preview" />Trabajar con la vista previa
...
## <a name="saving-a-report-to-a-file" />Guardar un informe en un archivo
...
### <a name="manage-scheduled-recurring-reports" />Administrar informes recurrentes programados
...
### <a name="printing-reports-in-thai" />Impresión de informes en tailandés
...
## <a name="switching-the-report-layout" />Cambiar el diseño del informe
...
## <a name="change-language-and-format-of-numbers-dates-and-times" />Cambiar idioma y formato de números, fechas y horas
...
## <a name="advanced-options" />Opciones avanzadas
