...
Esta opción solo está disponible para informes que utilizan un diseño RDLC. Exporta los resultados del reporte con el diseño RDLC aplicado. Utilice esta opción si desea exportar los datos una vez y solo desea realizar cambios menores en su apariencia, como la fuente y el esquema de color.
