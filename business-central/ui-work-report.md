...
Puede guardar el informe en un archivo (como Excel, Word o PDF), imprimirlo o solo generar el informe. Si guarda el informe en un archivo, el informe procesado se envía a la página **Bandeja de entrada de informes** en el área de tareas para que pueda verlo. Más información en [Compartir y exportar informes con la bandeja de entrada de informes](ui-work-report-inbox.md)
...
Más información en [(Versión heredada) Establecer el diseño utilizado por un informe](ui-set-report-layout.md). Pero, si desea personalizar su propio diseño del informe, consulte [Empezar a crear diseños](ui-get-started-layouts.md).
