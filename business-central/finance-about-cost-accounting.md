...
ms.author: edupont
---
# <a name="about-cost-accounting"></a><a name="about-cost-accounting"></a><a name="about-cost-accounting"></a>Acerca de la contabilidad de costos
...
## <a name="workflow-in-cost-accounting"></a><a name="workflow-in-cost-accounting"></a><a name="workflow-in-cost-accounting"></a>Flujo de trabajo en contabilidad de costos
...
## <a name="cost-types-cost-centers-and-cost-objects"></a><a name="cost-types-cost-centers-and-cost-objects"></a><a name="cost-types-cost-centers-and-cost-objects"></a>Tipos de costo, centros de costo y objetos de costos
...
## <a name="cost-entries-and-cost-journals"></a><a name="cost-entries-and-cost-journals"></a><a name="cost-entries-and-cost-journals"></a>Movimientos de costos y diarios de costos
...
## <a name="cost-allocations"></a><a name="cost-allocations"></a><a name="cost-allocations"></a>Asignaciones costo
...
## <a name="cost-budgets"></a><a name="cost-budgets"></a><a name="cost-budgets"></a>Presupuestos costo
...
## <a name="cost-reporting"></a><a name="cost-reporting"></a><a name="cost-reporting"></a>Información de costo
