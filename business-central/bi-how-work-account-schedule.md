...
Puede importar y exportar estructuras de cuentas como paquetes de configuración de RapidStart. Por ejemplo, esto resulta útil para compartirlos con otras empresas. El paquete se crea en un archivo .rapidstart, que entrega los contenidos de paquete en un formato comprimido.
