...
1. Elija el icono ![Bombilla que abre la función Dígame 2.](media/ui-search/search_small.png "Dígame qué desea hacer") , escriba **Informes financieros** y luego elija el vínculo relacionado.
...
Puede usar un informe financiero para crear un estado de cuenta que compare las cifras de contabilidad con las cifras presupuestadas.
...
6. Seleccione las cuentas que desea incluir en el estado de cuenta y, a continuación, elija **Aceptar**.
