...
Puede agregar un producto del tipo servicio como **Servicios de orden de trabajo** y obtener costos y precios de [!INCLUDE [prod_short](includes/prod_short.md)]. Para obtener más información, vaya a [Pestaña Productos y servicios](/dynamics365/field-service/work-order-experience#products-and-services-tab).
