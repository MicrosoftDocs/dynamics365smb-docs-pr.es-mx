...
## <a name="to-set-up-unrealized-sales-tax"></a><a name="to-set-up-unrealized-sales-tax"></a>Para configurar impuestos a las ventas no realizados
...
## <a name="to-set-up-unrealized-tax-for-jurisdictions"></a><a name="to-set-up-unrealized-tax-for-jurisdictions"></a>Para configurar impuestos no realizados para jurisdicciones
...
## <a name="to-set-up-adjustments-for-payment-discounts-in-a-tax-posting-group"></a><a name="to-set-up-adjustments-for-payment-discounts-in-a-tax-posting-group"></a>Para configurar ajustes para descuentos de pagos en un grupo contable de impuestos
...
## <a name="to-set-up-maximum-tax-correction-amounts"></a><a name="to-set-up-maximum-tax-correction-amounts"></a>Para configurar los importes máximos de corrección de impuestos
