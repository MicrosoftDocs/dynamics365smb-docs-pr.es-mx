...
## <a name="to-set-up-unrealized-sales-tax" />Para configurar impuestos a las ventas no realizados
...
## <a name="to-set-up-unrealized-tax-for-jurisdictions" />Para configurar impuestos no realizados para jurisdicciones
...
## <a name="to-set-up-adjustments-for-payment-discounts-in-a-tax-posting-group" />Para configurar ajustes para descuentos de pagos en un grupo contable de impuestos
...
## <a name="to-set-up-maximum-tax-correction-amounts" />Para configurar los importes máximos de corrección de impuestos
