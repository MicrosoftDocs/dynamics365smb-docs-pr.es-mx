...
## Para configurar el impuesto sobre servicios para un pedido de compra  
...
## Para configurar detalles del impuesto sobre servicios  
...
## Para configurar el impuesto a las compras para una empresa  
...
## Para configurar el impuesto a las compras para un almacén  
...
## Para configurar el impuesto a las compras para impuestos irrecuperables  
1.  Elija el icono ![Bombilla que abre la función Dígame.](../../../media/ui-search/search_small.png "Dígame qué desea hacer") , escriba **Detalles de impuestos** y, a continuación, elija el vínculo relacionado.  
