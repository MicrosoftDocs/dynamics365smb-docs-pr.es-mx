...
ms.author: edupont
---
# <a name="tax-identification-types-for-mexico" />Tipos identificación impuestos para México
...
## <a name="available-tax-identification-types" />Tipos de identificación fiscal disponibles
...
### <a name="registro-federal-de-contribuyentes-rfc" />Registro Federal de Contribuyentes (RFC)
...
### <a name="cdula-de-identification-fiscal-con-clave-nica-de-registro-de-poblacin-curp" />Cédula de identification fiscal con clave única de registro de población (CURP)
