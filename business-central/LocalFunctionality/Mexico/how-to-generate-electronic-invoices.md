...
---
# <a name="generate-electronic-invoices-in-the-mexican-version"></a><a name="generate-electronic-invoices-in-the-mexican-version"></a>Generar facturas electrónicas en la versión para México
...
## <a name="to-generate-electronic-invoices-for-sales-invoices"></a><a name="to-generate-electronic-invoices-for-sales-invoices"></a>Para generar facturas electrónicas de facturas de ventas
...
## <a name="receive-payments"></a><a name="receive-payments"></a>Recibir pagos
...
### <a name="to-stamp-the-payment"></a><a name="to-stamp-the-payment"></a>Para sellar un pago
...
## <a name="registering-export-comercio-exterior-complement"></a><a name="registering-export-comercio-exterior-complement"></a>Registro de exportaciones (Complemento de Comercio Exterior)
