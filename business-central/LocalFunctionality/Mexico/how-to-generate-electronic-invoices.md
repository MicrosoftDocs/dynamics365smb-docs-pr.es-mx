...
---
# <a name="generate-electronic-invoices-in-the-mexican-version" />Generar facturas electrónicas en la versión para México
...
## <a name="to-generate-electronic-invoices-for-sales-invoices" />Para generar facturas electrónicas de facturas de ventas
...
## <a name="receive-payments" />Recibir pagos
...
### <a name="to-stamp-the-payment" />Para sellar un pago
...
## <a name="registering-export-comercio-exterior-complement" />Registro de exportaciones (Complemento de Comercio Exterior)
