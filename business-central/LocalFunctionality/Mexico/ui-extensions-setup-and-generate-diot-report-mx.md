...
# <a name="set-up-and-generate-diot-reports"></a><a name="set-up-and-generate-diot-reports"></a>Configurar y generar informes DIOT
...
## <a name="what-does-this-extension-hhandle"></a><a name="what-does-this-extension-hhandle"></a>¿Qué es lo que maneja esta extensión?
...
## <a name="setup-of-the-mexican-diot-extension"></a><a name="setup-of-the-mexican-diot-extension"></a>Configuración de la extensión de DIOT de México
...
## <a name="optional-setup-for-reporting-withholding-tax-with-the-diot-extension"></a><a name="optional-setup-for-reporting-withholding-tax-with-the-diot-extension"></a>Configuración opcional para la generación de informes de retención de impuestos con la extensión de DIOT
...
### <a name="to-create-an-export-of-diot-report-files"></a><a name="to-create-an-export-of-diot-report-files"></a>Para crear una exportación de archivos de informe DIOT
