...
ms.author: edupont
---
# <a name="set-up-pac-web-services"></a><a name="set-up-pac-web-services"></a>Configuración de servicios web PAC
...
## <a name="to-add-the-certificates"></a><a name="to-add-the-certificates"></a>Para agregar los certificados
...
## <a name="to-set-up-a-pac-web-service"></a><a name="to-set-up-a-pac-web-service"></a>Para configurar el servicio web del PAC
