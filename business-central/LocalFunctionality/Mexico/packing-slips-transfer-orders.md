...
ms.author: edupont
---
# <a name="carta-de-porte-packing-slips-and-transfer-orders-in-the-mexican-version" />Remisiones y órdenes de transferencia de Carta de Porte en la versión para México
...
### <a name="to-add-sct-permission-to-company-information" />Para agregar el permiso de la SCT en la información de la empresa
...
### <a name="to-set-up-locations-for-carta-de-porte" />Para configurar las ubicaciones de Carta de Porte
...
### <a name="to-set-up-vehicles-for-transportation" />Para configurar los vehículos que realizarán el transporte
...
### <a name="to-configure-items" />Para configurar los artículos
...
## <a name="create-sales-documents-and-generate-packing-slips-and-transfer-orders-with-carta-de-porte" />Creación de documentos de venta y generación de remisiones con Carta de Porte
