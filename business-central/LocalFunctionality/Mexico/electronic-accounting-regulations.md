...
ms.author: bholtorf
---
# <a name="complying-with-electronic-accounting-regulations-in-mexico"></a><a name="complying-with-electronic-accounting-regulations-in-mexico"></a>Cumplimiento con las regulaciones electrónicas de la contabilidad en México
...
## <a name="setup-data-required-to-export-successfully"></a><a name="setup-data-required-to-export-successfully"></a>Configurar los datos necesarios para exportar correctamente
...
## <a name="to-generate-the-xml-files"></a><a name="to-generate-the-xml-files"></a>Para generar los archivos XML
