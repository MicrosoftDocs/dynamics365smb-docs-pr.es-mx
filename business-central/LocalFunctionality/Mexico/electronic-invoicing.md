...
ms.author: edupont
---
# <a name="electronic-invoicing-in-the-mexican-version"></a><a name="electronic-invoicing-in-the-mexican-version"></a>Facturación electrónica en la versión para México
...
## <a name="cancel-documents"></a><a name="cancel-documents"></a>Cancelar documentos
...
### <a name="send-a-posted-sales-invoice-for-cancellation"></a><a name="send-a-posted-sales-invoice-for-cancellation"></a>Enviar una factura de venta registrada para su cancelación
...
### <a name="send-a-request-to-update-the-status"></a><a name="send-a-request-to-update-the-status"></a>Enviar una solicitud de actualización de estado
...
### <a name="manually-cancel-a-posted-sales-invoice"></a><a name="manually-cancel-a-posted-sales-invoice"></a>Cancelar manualmente una factura de venta registrada
...
### <a name="e-invoice-status-request-batch"></a><a name="e-invoice-status-request-batch"></a>Lote de solicitudes de estado de factura electrónica
...
## <a name="communication-component"></a><a name="communication-component"></a>Componente de comunicación
