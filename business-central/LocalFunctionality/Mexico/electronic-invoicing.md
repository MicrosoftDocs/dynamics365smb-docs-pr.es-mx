...
ms.author: edupont
---
# <a name="electronic-invoicing-in-the-mexican-version" />Facturación electrónica en la versión para México
...
## <a name="cancel-documents" />Cancelar documentos
...
### <a name="send-a-posted-sales-invoice-for-cancellation" />Enviar una factura de venta registrada para su cancelación
...
### <a name="send-a-request-to-update-the-status" />Enviar una solicitud de actualización de estado
...
### <a name="manually-cancel-a-posted-sales-invoice" />Cancelar manualmente una factura de venta registrada
...
### <a name="e-invoice-status-request-batch" />Lote de solicitudes de estado de factura electrónica
...
## <a name="communication-component" />Componente de comunicación
