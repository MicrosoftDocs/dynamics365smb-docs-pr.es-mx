...
# <a name="set-up-electronic-invoicing---mexico"></a>Configurar la facturación electrónica (México)
...
## <a name="set-up-general-ledger-information"></a>Configurar la información de contabilidad general
...
## <a name="set-up-customer-and-vendor-information"></a>Configurar la información de clientes y proveedores
...
## <a name="set-up-location-information"></a>Configurar la información de almacén
...
## <a name="set-up-cancellation-reasons"></a>Configurar las razones de cancelación
...
## <a name="map-key-data-to-the-cfdi-fields"></a>Asignar datos clave a los campos de CFDI
...
#### <a name="map-your-country-codes-to-the-values-that-sat-requires"></a>Asignar los códigos de su país o región a los valores requeridos por el SAT
...
#### <a name="map-your-units-of-measure-to-the-values-that-sat-requires"></a>Asignar sus unidades de medida a los valores requeridos por el SAT
...
#### <a name="configure-sat-tax-regime-classification"></a>Configurar la clasificación de régimen fiscal del SAT
...
#### <a name="map-your-payment-methods-to-the-values-that-sat-requires"></a>Asignar sus formas de pago a los valores requeridos por el SAT
...
#### <a name="map-your-payment-terms-to-the-values-that-sat-requires"></a>Asignar sus términos de pago a los valores requeridos por el SAT
