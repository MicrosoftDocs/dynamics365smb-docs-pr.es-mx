...
|--|--|--|--|
| Grupos de actividades | Solo se muestra el grupo de actividades **Casa**. | Solo se muestra el grupo de actividades **Casa**. | **Casa** y **Documentos publicados** en el área de tareas `Sales Order Processor`. |  |
...
| Cuadros informativos | No se muestra en las páginas de la lista ni en las hojas de trabajo. | No se muestra en las páginas de la lista ni en las hojas de trabajo. | Lista `Customer` en el área de tareas `Small Business`. |
...
| Sangría en los controles del repetidor | Disponible. | No disponible. El control del repetidor se representará como un diseño de ladrillo plano normal. | Páginas de catálogo de cuentas y lista de contactos. |
