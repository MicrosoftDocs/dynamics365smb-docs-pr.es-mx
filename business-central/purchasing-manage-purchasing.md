...
| Realice análisis ad hoc de los datos de compra directamente en las páginas de listas y consultas. | [Análisis ad hoc de datos de compras](ad-hoc-analysis-purchasing.md) |
| Explore informes integrados para compras. | [Informes de compras integrados](purchase-reports.md) |

## <a name="quote-to-order-to-purchase-invoice"></a>De cotización a pedido a factura de compra
