...
> [!TIP]
> En la versión base de [!INCLUDE [prod_short](includes/prod_short.md)], las condiciones de pago no admiten pagos parciales. En su lugar, debe utilizar la función Anticipos. Para obtener más información sobre los anticipos, vaya a [Configurar anticipos](finance-set-up-prepayments.md).
>
