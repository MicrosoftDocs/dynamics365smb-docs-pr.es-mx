...
# <a name="set-up-standard-service-codes" />Configurar códigos de servicio estándar
...
## <a name="to-set-up-a-standard-service-code" />Para configurar un código de servicio estándar
...
## <a name="to-assign-a-standard-service-code-to-a-service-item-group" />Para asignar un código de servicio estándar a un grupo de productos de servicio
