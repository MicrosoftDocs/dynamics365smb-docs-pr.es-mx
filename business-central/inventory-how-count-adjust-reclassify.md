...
Cuente el inventario físico, es decir, cuente los productos reales disponibles, para comprobar si la cantidad registrada coincide con la cantidad física en inventario. Por lo general, los recuentos se realizan al final del año fiscal, pero a veces se realizan con más frecuencia. Si hay diferencias, registre las cantidades reales en las cuentas de productos <!--accounts, or ledger?--> antes de hacer la valoración del inventario.
...
2. En la página **Lista del inventario físico almacén**, especifique si el informe mostrará el inventario calculado y los productos de inventario por números de serie y lote.
