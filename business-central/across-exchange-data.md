...
|Prepare la importación de un archivo de estado de cuenta bancario a la página **Diario de conciliación de pagos** como el primer paso para conciliar pagos o a la página **Conciliación banco** como el primer paso para conciliar cuentas bancarias.|[Configurar el servicio Envestnet Yodlee Bank Feeds](bank-how-setup-bank-statement-service.md)|  
...
|Ver qué elementos de archivo están asignados a campos de [!INCLUDE[prod_short](includes/prod_short.md)] al importar archivos de estado de cuenta CAMT de SEPA.|[Asignación de campos al importar archivos CAMT de SEPA](across-field-mapping-when-importing-sepa-camt-files.md)|  
