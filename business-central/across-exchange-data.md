...
|Prepare la importación de un archivo de estado de cuenta bancario a la página **Diario de conciliación de pagos** como el primer paso para conciliar pagos o a la página **Conciliación banco** como el primer paso para conciliar cuentas bancarias.|[Configuración del Envestnet Yodlee Bank Feeds Service](bank-how-setup-bank-statement-service.md)|  
