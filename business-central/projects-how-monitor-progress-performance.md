...
1. Elija el icono ![Bombilla que abre la función Dígame.](media/ui-search/search_small.png "Dígame qué desea hacer") , escriba **registrar wip en g/l proyecto**, y luego elija el enlace relacionado.  
...
Cuando haya terminado todas las actividades de un proyecto, incluidos el registro de consumo y la facturación, tiene que actualizarlo para que su **Estado** sea **Completado**. Después, debe revertir cualquier WIP que haya registrado en contabilidad.
