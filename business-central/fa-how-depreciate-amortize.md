...
La amortización se utiliza para distribuir el costo de activos, como maquinaria y equipos, a lo largo de su vida amortizable. Para cada activo fijo, debe definir cómo depreciarlo.  
...
Una vez al mes, o cuando desee, puede ejecutar el proceso **Calcular amortización**. El trabajo por lotes ignora los activos fijos vendidos, bloqueados o inactivos, o bien usa el método de amortización manual.  
...
4. Elija el icono ![Bombilla que abre la función Dígame.](media/ui-search/search_small.png "Dígame qué desea hacer") , escriba **Diarios generales A/F**, y luego elija el enlace relacionado.  
    ...
    En la página **A/F Diario C/G activos fijos**, en el campo **N.º días amortización**, puede ver la cantidad de días de amortización calculados.  
...
1. Elija el icono ![Bombilla que abre la función Dígame.](media/ui-search/search_small.png "Dígame qué desea hacer") , escriba **Diario general de activos fijos** y, luego, elija el vínculo relacionado.  
...
Si configuró las claves de distribución de activos fijos para distribuir importes entre varios departamentos o proyectos, los importes se distribuyen durante el registro. Para obtener más información, consulte [Configurar información general de activos fijos](fa-how-setup-general.md).  

## Para administrar el valor contable final

En el campo **Valor contable final** en la página **Libros amortización A/F**, puede especificar el valor contable que desea que tenga su activo fijo en el libro de amortización actual después de que se haya depreciado por completo. Puede introducir el valor manualmente o puede completar el campo **Valor contable final genérico** en la página **Libro de amortización** relacionada. El valor rellena automáticamente el campo.
...
4. A continuación, elija la ![Bombilla que abre la característica Dígame](media/ui-search/search_small.png "Dígame qué desea hacer") , escriba **Diarios generales de activos fijos** y, a continuación, elija el vínculo relacionado.
5. Introduzca el activo fijo para que el correspondiente grupo contable de activos fijos y el libro de amortización determinen las líneas de asignación.
6. Elija la acción **Registrar** para registrar el diario.

> [!NOTE]  
> Si varios departamentos utilizan un activo fijo, puede seleccionar la dimensión en la línea del diario de contabilidad general de activos fijos.
...
Las líneas copiadas se crean en el diario de contabilidad general de activos fijos o en el de activos fijos, según si el libro de amortización que va a copiar tiene integración con la contabilidad general.  
