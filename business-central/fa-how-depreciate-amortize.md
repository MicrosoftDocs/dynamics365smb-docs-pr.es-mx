...
## <a name="to-calculate-allocations-in-the-fixed-asset-gl-journal" />Para calcular distribuciones en el diario general de activos fijos
...
## <a name="to-copy-fixed-asset-ledger-entries-between-depreciation-books" />Para copiar los movimientos de activos fijos entre los libros de amortización
