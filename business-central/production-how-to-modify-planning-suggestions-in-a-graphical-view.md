...
description: 'Una actividad típica de planificación: cambiar o agregar líneas de la hoja de planificación para modificar las órdenes de suministro sugeridas antes de confirmar la ejecución de la función Ejecutar mensajes acción.'
author: SorenGP
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
