...
* El valor del campo **Diferencia** es inferior al valor del campo **Importe de transacción**, que indica que una parte del pago se puede liquidar con un movimiento de cliente, proveedor o banco pendiente relacionado. La parte restante del pago no se puede aplicar y debe conciliarse manualmente o publicándolo directamente en una cuenta.
