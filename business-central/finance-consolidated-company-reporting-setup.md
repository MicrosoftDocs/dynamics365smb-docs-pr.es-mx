...
* Si necesita alguna configuraciones más avanzada, puede configurar las empresas consolidadas y las unidades de negocio manualmente.
  * En cada unidad de negocio, especifique qué cuentas de contabilidad general deben incluirse en la consolidación e indique el método de traducción de consolidación para cada cuenta.
  * En la empresa consolidada, configure una tarjeta de unidad de negocio para cada empresa que se desee incluir en la consolidación. La tarjeta de unidad de negocio incluye información como las fechas del ejercicio de la unidad de negocio y el porcentaje de cada cuenta que debe incluirse en la consolidación.
...
1. Configurar el catálogo de cuentas
    ...
    Para obtener más información, consulte [Configurar o cambiar el catálogo de cuentas](finance-setup-chart-accounts.md).  
...
2. Agregar unidades de negocio
    ...
    Para consolidar los datos financieros de varias empresas en una sola empresa consolidada, debe especificar la información sobre las subsidiarias como unidades de negocio que se deben incluir y sobre el grado hasta el que se incluirán sus cifras.
...
### <a name="add-business-units"></a><a name="add-business-units"></a><a name="add-business-units"></a><a name="busunit"></a>Agregar unidades de negocio
...
El catálogo de cuentas de una empresa que se va consolidar debe especificar las cuentas para consolidación. Por cada cuenta de contabilidad de cada empresa, debe especificar la cuenta de la empresa consolidada a la que se transferirá el saldo tras la consolidación. Esta asignación permitirá que se puedan consolidar empresas con catálogos de cuentas diferentes.
...
* En las dimensiones relevantes, especifique el campo **Código de consolidación** o déjelo en blanco
  ...
  * Para incluir información de dimensión en la consolidación, deje el campo **Código de consolidación** en blanco. Sin embargo, la consolidación solo funcionará si los valores de dimensión de la unidad de negocio son iguales a los de la empresa consolidada.
  * Para consolidar el código de valor de dimensión de la unidad de negocio con un código de valor de dimensión distinto en la empresa consolidada, rellene el campo **Código de consolidación** en las dimensiones correspondientes.  
