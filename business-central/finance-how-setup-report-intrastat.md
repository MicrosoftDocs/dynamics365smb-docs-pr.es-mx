...
3. Para asignar un código de mercancía a un producto, vaya a la ventana **Ficha de producto**, expanda la ficha desplegable **Costos y registro** y, a continuación introdúzcalo en el campo **Código de mercancía**.   
