---
title: Obtener el complemento de Business Central para Outlook
...
ms.author: jswymer
---
# <a name="get-the-business-central-add-in-for-outlook"></a><a name="get-the-business-central-add-in-for-outlook"></a><a name="get-the-business-central-add-in-for-outlook"></a>Obtener el complemento de Business Central para Outlook

Con [!INCLUDE[prod_short](includes/prod_short.md)] puede administrar interacciones comerciales con sus clientes y proveedores directamente en Microsoft Outlook. Con el complemento de [!INCLUDE[prod_short](includes/prod_short.md)] Outlook, verá datos financieros relacionados con clientes y proveedores. También puede crear y enviar documentos financieros, como cotizaciones y facturas.  

Hay dos formas de instalar el complemento de Business Central para Outlook, según su rol en la organización:
...
- Información del contacto
    ...
    Este complemento proporciona a los usuarios información del cliente o proveedor de [!INCLUDE[prod_short](includes/prod_short.md)] en los correos electrónicos de Outlook y las citas del calendario. También le permite crear y enviar documentos comerciales de [!INCLUDE[prod_short](includes/prod_short.md)], como cotizaciones de venta y facturas a un contacto. <!--To support these task, the add-in adds actions to the Outlook ribbon, in the **Business Central** group. --> 
...
1. En Business Central, vaya al icono ![Bombilla que abre la función Dígame.](media/ui-search/search_small.png "Dígame qué desea hacer") , escriba **Obtener el complemento de Outlook** y, luego, elija el vínculo relacionado.
...
5. Abra Outlook y elija **Obtener complementos** en la cinta de opciones. O bien, si usa Outlook en la web, seleccione el menú desplegable en cualquier mensaje de correo electrónico nuevo o existente, luego seleccione **Obtener complementos**.
