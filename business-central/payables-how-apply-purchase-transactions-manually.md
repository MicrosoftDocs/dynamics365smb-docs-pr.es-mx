...
## <a name="to-apply-a-credit-memo-to-a-single-or-multiple-vendor-ledger-entries" />Para liquidar una nota de crédito con uno o varios movimientos de proveedor
