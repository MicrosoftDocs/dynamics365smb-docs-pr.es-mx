...
### Para configurar que un movimiento de inventario se cree automáticamente cuando se crea el picking de inventario para el producto de ensamblado
...
### Para configurar la ubicación en el área de ensamblado donde los productos de ensamblado terminados se registran cuando se ensamblan para stock
...
### Para configurar la ubicación en la que los productos de ensamblado terminados se registran cuando se ensamblan para un pedido de venta asociado
