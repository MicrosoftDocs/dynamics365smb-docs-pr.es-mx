...
Para muchas empresas, el año fiscal no coincide con el año calendario, por ejemplo cuando el año fiscal termina el 30 de junio en lugar del 31 de diciembre. En el caso de las empresas de nueva creación, el período fiscal podría incluso ser superior a 12 meses.  
...
Puede usar periodos contables en informes, como cuando revisa los movimientos registrados en la página **Saldo/Presupuesto**, donde se puede especificar el intervalo de informes. Una de las opciones que podría especificar es informar por período contable. También puede crear un informe financiero que compare los resultados de diferentes períodos contables.
...
Cerrar el ejercicio es una de las tareas para cerrar los libros. Después de cerrar un ejercicio, se seleccionan las casillas **Cerrado** y **Fecha bloqueada** de todos los periodos del ejercicio. No puedes volver a abrir un año ni desmarcar las casillas de verificación.
