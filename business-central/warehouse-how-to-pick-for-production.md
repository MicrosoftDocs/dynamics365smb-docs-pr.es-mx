---
title: 'Seleccionar o mover artículos para producción, ensamblaje o proyectos en configuraciones básicas de almacén'
...
---
# <a name="pick-for-production-assembly-or-projects-in-basic-warehouse-configurations"></a>Selección para producción, ensamblaje o proyectos en configuraciones básicas de almacén
...
En una configuración básica de almacén para el flujo de salida (pick), en la página  **Ubicación tarjeta**  de la ubicación, active las siguientes configuraciones:

* Producción, Seleccionar **Selección/Movimiento de Inventario** en el campo **Manejo de Producción, Consumo y Venta al por Mayor** .
* Ensamblaje, Seleccionar **Movimiento de inventario** en el campo **Manejo de inventario de consumo en almacén** .
* Gestión de proyectos, Seleccionar **Selección de inventario** en el campo **Manejo de almacén de consumo de proyectos** .
...
* Cuando se registra una selección de inventario para una operación interna, como producción o un proyecto, el consumo de los componentes seleccionados se registra al mismo tiempo.
...
1. En el documento de origen, que puede ser una orden de producción o un proyecto, seleccione la acción  **Crear ubicación/selección de inventario** .  
...
1. En el documento de origen, que puede ser una orden de producción, una orden de ensamblaje o un proyecto, seleccione la acción  **Crear ubicación/selección de inventario** .  
...
|Proyectos | Cambie el estado de un proyecto a **Abierto** o cree un proyecto con el estado Abierto de inmediato.|  
...
1. Elija el icono ![Bombilla que abre la función Dígame.](media/ui-search/search_small.png "Dígame qué desea hacer") , escriba **Picking de inventario** o **Movimiento de inventario** y luego elija el enlace relacionado.  
...
5. Como alternativa, puede elegir la acción **Tomar documento origen** para seleccionar un documento de una lista de documentos de origen de entrada que están preparados para el picking en el almacén.  
