...
En la sección Power BI de su página Web, puede elegir la acción **Administrar informe** de la lista desplegable de comandos para poder modificar el informe que se centraba en el área de tareas.  
...
Regrese al área de tareas y aparecerá el informe actualizado. Si ha ejecutado un comando Guardar como, deberá abrir la página de selección de informe y habilitar el nuevo informe.
