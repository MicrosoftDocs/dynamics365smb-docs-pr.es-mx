...
El siguiente procedimiento muestra cómo realizar el seguimiento de un paquete desde una remisión de venta registrada, pero se aplican los mismos pasos para habilitar el seguimiento del paquete desde las páginas Factura de venta registrada, Notas de crédito de venta registrada y Recepción de devolución registrada.  
