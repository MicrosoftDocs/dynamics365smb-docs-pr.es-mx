...
ms.author: edupont
---
# <a name="setting-up-cost-accounting" />Configuración de contabilidad de costos

Antes de empezar a trabajar con la contabilidad de costos, debe realizar tareas de configuración.

## <a name="balances-between-cost-type-cost-center-and-cost-object" />Saldos entre el tipo de costo, centro de costo y objeto de costo
...
## <a name="setting-up-cost-types" />Configuración de tipos de costo
...
### <a name="to-transfer-the-general-ledger-chart-of-accounts-to-the-chart-of-cost-types" />Para transferir el Catálogo de cuentas de contabilidad al plan de tipos de costo
...
### <a name="to-set-up-new-cost-types-in-the-chart-of-cost-types-page" />Configurar nuevos tipos de costo en la página Tipos centros costo
...
### <a name="to-update-cost-types" />Para actualizar tipos de costo
...
## <a name="defining-the-relationship-between-cost-types-and-general-ledger-accounts" />Definición de la relación entre los tipos de costo y las cuentas de contabilidad
...
### <a name="relationship-between-general-ledger-accounts-and-cost-types" />Relación entre las cuentas de contabilidad y los tipos de costo
...
### <a name="cost-types-without-a-relationship-to-the-general-ledger" />Tipos de costo sin una relación con la contabilidad
...
## <a name="setting-up-cost-centers" />Configuración de centros de costo
...
### <a name="to-transfer-dimension-values-in-the-general-ledger-to-the-chart-of-cost-centers" />Para transferir los valores de dimensión en la contabilidad al plan de centros de costo
...
### <a name="to-create-new-cost-centers-in-the-chart-of-cost-centers-page" />Crear nuevos centros de costo en la página Plan centros costo
...
## <a name="setting-up-cost-objects" />Configuración de objetos de costo
...
### <a name="to-transfer-dimension-values-from-the-general-ledger-to-the-chart-of-cost-objects" />Para transferir valores de dimensión de la contabilidad al plan de objetos de costo
...
### <a name="to-create-new-cost-objects-in-the-chart-of-cost-objects-page" />Crear nuevos objetos de costo en la página Plan objetos costo
...
## <a name="defining-cost-centers-and-cost-objects-for-chart-of-accounts" />Definición de centros de costo y de objetos de costo para el Catálogo de cuentas
...
### <a name="defining-dimension-values-for-overhead-costs-and-direct-costs" />Definición de valores de dimensión para costos generales y costos directos
