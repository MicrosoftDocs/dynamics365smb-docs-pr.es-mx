---
title: Configurar contabilidad de costos
...
# <a name="set-up-cost-accounting"></a>Configurar contabilidad de costos

Antes de empezar a trabajar con la contabilidad de costos, debe realizar tareas de configuración.

## <a name="balances-between-cost-type-cost-center-and-cost-object"></a>Saldos entre tipo de costo, centro de costo y objeto de costo
...
## <a name="set-up-cost-types"></a>Configurar tipos de costos
...
1. Configure una dimensión para que sea la dimensión del centro de costo en la página **Configuración de contabilidad de costos**. Sólo los valores de esta dimensión se transfieren.
Puede elegir la acción  **Actualizar dimensiones de contabilidad de costos**  para actualizar las dimensiones de contabilidad de costos.
1. Elija el icono ![Bombilla que abre la función Dígame 2.](media/ui-search/search_small.png "Dígame qué desea hacer") , escriba **Plan de centros de costo** y, luego, elija el vínculo relacionado.  
1. En la pestaña **Acciones**, en el grupo **Funciones**, seleccione **Tomar centros de costo de dimensión** para transferir los valores de dimensión al plan de centros de costo. La función transfiere los valores de dimensión que definió en el paso 1.  
...
> [!NOTE]  
>  Para asegurarse de que el centro de costo y el objeto de costo predefinidos que configuró en el libro mayor se transfieran automáticamente a la contabilidad de costos, marque la casilla de verificación  **Verificar contabilizaciones en el libro mayor**  en la página  **Configuración de contabilidad de costos** .
