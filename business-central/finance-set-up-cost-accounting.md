...
|Para|Vea|  
|--------|---------|  
|Cree el plan de tipos de costo.|[Configurar tipos de costo](finance-how-to-set-up-cost-types.md)|  
...
|Cree el plan de centros de costo.|[Configurar centros de costo](finance-how-to-set-up-cost-centers.md)|  
|Cree el plan de objetos de costo.|[Configurar objetos de costo](finance-how-to-set-up-cost-objects.md)|  
