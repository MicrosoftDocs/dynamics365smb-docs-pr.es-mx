---
title: Concilie los pagos de clientes con el diario de recepción de efectivo o de los movimientos de cliente.
description: Describe cómo liquidar las recepciones de efectivo o los reembolsos en uno o varios movimientos contables de clientes pendientes. Esto es parte de la conciliación de los pagos de los clientes.
author: SorenGP
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
...
ms.author: edupont
---
# <a name="reconcile-customer-payments-with-the-cash-receipt-journal-or-from-customer-ledger-entries"></a><a name="reconcile-customer-payments-with-the-cash-receipt-journal-or-from-customer-ledger-entries"></a><a name="reconcile-customer-payments-with-the-cash-receipt-journal-or-from-customer-ledger-entries"></a>Concilie los pagos de clientes con el diario de recepción de efectivo o de los movimientos de cliente.

Cuando recibe un pago de un cliente o efectúa un reembolso, puede liquidar el pago o reembolsarlo para cerrar débitos o haber pendientes. Puede especificar el importe a liquidar. Por ejemplo, puede liquidar pagos parciales en movimientos de cliente. El cierre de movimientos contables de cliente mantiene al día las estadísticas de cliente, los estados de cuenta de la cuenta, los intereses, etc.
...
* Al introducir información en páginas dedicadas:
    ...
    * El **Diario de recepciones de efectivo**. Esta opción se describe a continuación.
* Rellenando el campo **Liq. por nº documento** en documentos de nota de crédito de venta. Esta opción se describe a continuación.
...
## <a name="to-fill-and-post-a-cash-receipt-journal"></a><a name="to-fill-and-post-a-cash-receipt-journal"></a><a name="to-fill-and-post-a-cash-receipt-journal"></a>Para rellenar y registrar un diario de recepción de efectivo
Un diario de recepciones de efectivo es un tipo de diario general. Puede usarlo para registrar transacciones en cuentas de contabilidad, bancos, clientes, proveedores y activos fijos. Puede liquidar el pago a una o más entradas del debe cuando registra el pago. También puede aplicar desde las entradas publicadas más tarde.
1. Elija el icono ![Bombilla que abre la función Dígame.](media/ui-search/search_small.png "Dígame qué desea hacer") , escriba **Diario de recepciones de efectivo** y, luego, elija el vínculo relacionado.
...
1. Elija el icono ![Bombilla que abre la función Dígame.](media/ui-search/search_small.png "Dígame qué desea hacer") , escriba **Diario de recepciones de efectivo** y elija el vínculo relacionado.
2. Seleccione la acción **Editar diario**.
...
10. Elija el botón **Aceptar**. La página **Diario de recepciones de efectivo** ahora muestra el movimiento en los campos **Liq. por tipo documento** y **Liq. por n.º documento**.
...
## <a name="to-apply-a-credit-memo-to-a-single-customer-ledger-entry"></a><a name="to-apply-a-credit-memo-to-a-single-customer-ledger-entry"></a><a name="to-apply-a-credit-memo-to-a-single-customer-ledger-entry"></a>Para liquidar una nota de crédito a un único movimiento de cliente
...
5. Elija el botón **Aceptar**. La página **Nota de crédito de venta** ahora muestra el movimiento que ha introducido en los campos **Liq. por tipo documento** y **Liq. por n.º documento**. Asimismo, muestra el importe de la nota de crédito que se va a registrar, ajustado con los posibles descuentos por pronto pago.
6. Registre la nota de crédito

## <a name="to-apply-a-credit-memo-to-multiple-customer-ledger-entries"></a><a name="to-apply-a-credit-memo-to-multiple-customer-ledger-entries"></a><a name="to-apply-a-credit-memo-to-multiple-customer-ledger-entries"></a>Para liquidar una nota de crédito a varios movimientos de cliente
1. Elija el icono ![Bombilla que abre la función Dígame.](media/ui-search/search_small.png "Dígame qué desea hacer") , escriba **Notas de crédito de venta** y, a continuación, elija el vínculo relacionado.
2. Abra la nota de crédito de venta correspondiente.
...
5. En cada línea del campo **Importe a liquidar**, introduzca el importe con el que desea liquidar cada movimiento. Si no especifica ningún importe, se usa el importe máximo.  
    ...
    Al final de la página **Movs. pendientes cliente**, podrá ver el importe específico incluido en el campo **Importe liquidado** y también si la liquidación está cuadrada.  
6. Elija el botón **Aceptar**. La página **Nota de crédito de venta** mostrará el importe de la nota de crédito para registrar, ajustado para los posibles descuentos de pago.
...
En la lista de movimientos contables, en la línea que contiene el movimiento contable que se liquidó completamente, puede ver que la casilla **Pendiente** no está marcada.  
