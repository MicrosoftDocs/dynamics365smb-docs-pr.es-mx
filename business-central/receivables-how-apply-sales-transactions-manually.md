...
* Rellenando el campo **Liq. por nº documento** en documentos de nota de crédito de venta. Este se describe a continuación.
...
Un diario de recepción de efectivo es un tipo de diario general, por lo que puede usarlo para registrar transacciones en cuentas contables, de banco, de cliente, de proveedor y de activos fijos. Puede liquidar el pago de uno o más movimientos de débito cuando registra el pago o puede liquidarlos desde movimientos registrados posteriormente.
1. Elija el icono ![Bombilla que abre la función Dígame](media/ui-search/search_small.png "Dígame qué desea hacer"), escriba **Diario de recepción de efectivo** y luego elija el enlace relacionado.
...
1. Elija el icono ![Bombilla que abre la función Dígame](media/ui-search/search_small.png "Dígame qué desea hacer"), escriba **Diario de recepción de efectivo** y elija el enlace relacionado.
2. Seleccione la acción **Editar diario**.
...
10. Elija el botón **Aceptar**. La página **Diario de recepción de efectivo** ahora muestra el movimiento que ha introducido en los campos **Liq. por tipo documento** y **Liq. por n.º documento**.
...
1. Elija el icono ![Bombilla que abre la función Dígame](media/ui-search/search_small.png "Dígame qué desea hacer"), escriba **Diario de recepciones de efectivo** y luego elija el enlace relacionado.
