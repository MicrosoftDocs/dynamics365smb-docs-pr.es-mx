...
* Rellenando el campo **Liq. por nº documento** en documentos de nota de crédito de venta. Para obtener más información, consulte  [Para aplicar una nota de crédito a una sola entrada del libro mayor de clientes](#to-apply-a-credit-memo-to-a-single-customer-ledger-entry).
...
1. Elija el icono ![Bombilla que abre la función Dígame.](media/ui-search/search_small.png "Dígame qué desea hacer") Icono, ingrese  **Diario de recibos de caja** y seleccione el vincular relacionado.
2. Seleccione la acción **Editar diario**.
...
5. Elija el botón **Aceptar**. La página  **Nota de crédito de ventas** ahora muestra la entrada que seleccionó en los campos  **Se aplica a tipo de documento**  y  **Se aplica a número de documento** . Asimismo, muestra el importe de la nota de crédito que se va a registrar, ajustado con los posibles descuentos por pronto pago.
