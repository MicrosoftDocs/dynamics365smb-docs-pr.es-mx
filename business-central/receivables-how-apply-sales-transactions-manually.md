...
* Introduciendo información en páginas específicas, como **Diario de recepción de efectivo** y **Diario de conciliación de pagos**.
...
Puede liquidar pagos de cliente manualmente en la página **Diario de recepción de efectivo**. Un diario de recepciones de efectivo es un tipo de diario general, por lo que puede usarlo para registrar transacciones en cuentas contables, de banco, cliente, proveedor y activos fijos. Puede liquidar el pago de uno o más movimientos de débito cuando registra el pago o puede liquidarlos desde movimientos registrados posteriormente.
