...
---
# <a name="design-details-handling-reordering-policies"></a><a name="design-details-handling-reordering-policies"></a>Detalles de diseño: Gestión de directivas de reorden
...
## <a name="the-role-of-the-reorder-point"></a><a name="the-role-of-the-reorder-point"></a>Función del punto de reorden
...
## <a name="monitoring-the-projected-inventory-level-and-the-reorder-point"></a><a name="monitoring-the-projected-inventory-level-and-the-reorder-point"></a>Supervisión del nivel de inventario proyectado y el punto de reorden
...
#### <a name="fixed-reorder-qty"></a><a name="fixed-reorder-qty"></a>Cdad. fija reordenada
...
## <a name="reordering-policies"></a><a name="reordering-policies"></a>Políticas de reorden
...
### <a name="fixed-reorder-quantity"></a><a name="fixed-reorder-quantity"></a>Cantidad fija reordenada
