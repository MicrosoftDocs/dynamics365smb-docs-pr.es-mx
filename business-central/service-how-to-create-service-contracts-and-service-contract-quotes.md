...
6. En las líneas de nota de crédito, especifique información acerca de los productos devueltos o eliminados o acerca de la deducción que se enviará. También puede utilizar el proceso **Trae movs. contrato prepag**.  
 ...
 Para crear manualmente una nota de crédito cuando se quiten líneas de contrato de un contrato de servicio, en la página **Contrato de servicio**, en la pestaña **Acciones**, en el grupo **Funciones**, elija **Nota de crédito**.  
