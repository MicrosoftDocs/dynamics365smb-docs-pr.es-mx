...
1. Elija el icono ![bombilla que abre la función Dígame](media/ui-search/search_small.png "Dígame que desea hacer"), escriba **Cotizaciones de contrato de servicio** y luego elija el enlace relacionado.  
...
4. En el campo **Nº cliente**, especifique el número del cliente del contrato de servicio.  
    ...
    > [!NOTE]  
    >  Puede comparar la nota de crédito con el documento original registrado en la página **Facts. ventas (servicio) regis.**. Elija el icono ![bombilla que abre la función Dígame](media/ui-search/search_small.png "Dígame que desea hacer"), escriba **Facturas de servicios reg.** y luego elija el enlace relacionado.  
...
1. Elija el icono ![bombilla que abre la función Dígame](media/ui-search/search_small.png "Dígame que desea hacer"), escriba **Cotizaciones de contrato servicio** y elija el enlace relacionado.  
...
1. Elija el icono ![bombilla que abre la función Dígame](media/ui-search/search_small.png "Dígame que desea hacer"), escriba **Contratos de servicio** y luego elija el enlace relacionado. Abra el contrato de servicio correspondiente cuyo propietario desee modificar.  
