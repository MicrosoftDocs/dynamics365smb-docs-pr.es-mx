...
ms.author: bholtorf
---
# <a name="work-with-service-contracts-and-service-contract-quotes" />Trabajar con contratos de servicio y cotizaciones de contrato de servicio
...
## <a name="to-create-a-service-contract-or-service-contract-quote" />Para crear un contrato o cotización de contrato de servicio
...
## <a name="to-convert-a-service-contract-quote-to-service-contract" />Para convertir una cotización de contrato de servicio en un contrato de servicio
...
## <a name="to-create-contract-service-credit-memos" />Para crear notas de crédito de servicio de contrato
...
## <a name="to-add-a-contract-line-to-a-service-contract-or-contract-quote" />Para agregar una línea de contrato a una cotización de contrato o contrato de servicio
...
## <a name="service-line-cost-and-value" />Costo y valor de la línea de servicio
...
## <a name="to-add-a-contract-discount-to-service-contract-quotes" />Para agregar un descuento de contrato a las cotizaciones de contrato de servicios
...
## <a name="to-post-prepaid-contract-entries" />Para registrar movimientos de contrato de anticipo
...
## <a name="filing-a-service-contract-or-contract-quote" />Archivado de un contrato de servicio o cotización de contrato
