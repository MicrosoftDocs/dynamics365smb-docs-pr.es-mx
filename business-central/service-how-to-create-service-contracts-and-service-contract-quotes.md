...
4. En el campo **Nº cliente**, especifique el número del cliente del contrato de servicio.  
    ...
    > [!NOTE]  
    >  Puede comparar la nota de crédito con el documento original registrado en la página **Facts. ventas (servicio) regis.**. Elija el icono ![Bombilla que abre la función Dígame](media/ui-search/search_small.png "Dígame qué desea hacer"), escriba **Facturas servicio registradas** y luego elija el enlace relacionado.  
...
1. Elija el icono ![Bombilla que abre la función Dígame](media/ui-search/search_small.png "Dígame qué desea hacer"), escriba **Cotizaciones Contrato de Servicio** y elija el enlace relacionado.  
