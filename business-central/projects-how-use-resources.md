...
description: 'Describe cómo puede registrar el uso o consumo de recursos asociados a un proyecto, para realizar el seguimiento y administrar costos, precios y tipos de trabajo.'
author: brentholtorf
ms.topic: how-to
...
El consumo de los recursos en el diario de proyectos se registra para hacer un seguimiento de costos, precios y tipos de trabajo que están vinculados a proyectos. Para obtener más información, consulte [Registro del uso para proyectos](projects-how-record-job-usage.md).
...
## Para obtener propuestas de modificación de precios de recursos basadas en precios alternativos existentes
...
## Para obtener propuestas de cambio de precio de recursos basadas en precios estándar
...
## Para obtener propuestas de modificación de precios de recursos basadas en precios alternativos
