...
- Para descartar todas las coincidencias propuestas y cerrar la ventana de Copilot, seleccione el botón de descartar (papelera) ![Muestra el ícono de la papelera para eliminar todas las propuestas de Copilot para la conciliación de cuentas bancarias](media/copilot-delete-trash-can.png) al lado del botón **Mantenerlo** en la parte inferior de la ventana.
   ...
   > 
   > Si inició Copilot desde la lista **Conciliaciones de cuenta bancaria**, no se guarda nada, incluidas las líneas del estado de cuenta de banco importadas, las automatizaciones y las coincidencias propuestas por Copilot.
...
En esta sección, aprenderá a utilizar Copilot para transferir estados de cuenta de banco no conciliadas del libro mayor de cuentas bancarias a una cuenta del libro mayor. Esta tarea sólo se puede realizar a partir de una conciliación existente. 
...
2. En el panel **Líneas de estado de cuenta de banco**, identifique el panel de líneas de estado de cuenta de banco que no coinciden y seleccione una o más líneas que desee conciliar.
