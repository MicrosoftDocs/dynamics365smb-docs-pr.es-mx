...
## <a name="url"></a>Obtener la dirección URL de OneDrive
...
5. Elija **Conexión de prueba** y espere los resultados.
   ...
   - Si la prueba tiene errores, recibe un mensaje que describe el problema. Por lo general, el problema tiene que ver con la URL que proporcionó. Elija **Aceptar** para volver a la página **Configurar Business Central**, verifique la URL y vuelva a intentarlo.
