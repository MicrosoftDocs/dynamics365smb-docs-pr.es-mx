...
|Especifique si los usuarios pueden contabilizar facturas de ventas y si deben contabilizarlas junto con las remisiones. |[Definir una directiva de registro de facturas para los usuarios](admin-setup-invoice-posting-policy.md)|
