...
ms.author: edupont
---
# <a name="create-blanket-assembly-orders" />Crear pedidos abiertos ensamblados
...
## <a name="to-create-a-blanket-assembly-order-for-an-assemble-to-order-item" />Crear un pedido de ensamblado abierto para un artículo de ensamblado para pedido
