...
5. Elija la acción **Proceso**, luego elija la acción **Revertir líneas de documentos registrados**.
...
Quizás decida cobrar a su cliente un cargo de reaprovisionamiento para cubrir los costos de manipulación física en la devolución de un producto. Esto podría suceder, por ejemplo, si el cliente pidió por error el producto equivocado o cambió de parecer una vez recibido el producto que le vendió.
