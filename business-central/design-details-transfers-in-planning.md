...
* Una orden de suministro da la cara directamente a una orden de demanda
...
> [!NOTE]
> Si se definió un plazo, habrá discontinuidad entre el envío y la recepción. El plazo puede tener más elementos, como tiempo de transporte y tiempo de manipulación en el almacén. En una escala de tiempo, el sistema de planificación retrocede en el tiempo mientras cuadra los elementos.  
