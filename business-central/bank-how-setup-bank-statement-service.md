...
> [!NOTE]  
> Si usa la configuración asistida Configurar empresa, algunos de los pasos de los procedimientos siguientes se producen automáticamente cuando accede a la configuración de la cuenta bancaria de la empresa. Para obtener más información, vea [Introducción](product-get-started.md).
