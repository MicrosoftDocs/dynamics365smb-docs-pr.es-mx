...
Un L.M. de ensamblado es los datos maestros que definen qué artículos componentes forman un producto final ensamblado y que recursos se utilizan para ensamblar el producto de ensamblado. Cuando introduzca un producto de ensamblado y una cantidad en un encabezado de una nueva orden de ensamblado, las líneas de órdenes de ensamblado se rellenan automáticamente en las L.M. de ensamblado con una línea de orden de ensamblado por componente o recurso. Obtenga más información en [Administración de ensamblados](assembly-assemble-items.md).
