...
Para probar el flujo de aprobación, Pedro primero inicia sesión en [!INCLUDE[prod_short](includes/prod_short.md)] como Alicia y, a continuación, solicita aprobación de un pedido de compra. Después inicia sesión como él mismo, ve la nota en su área de tareas, sigue el vínculo a la solicitud de aprobación del pedido de compra y aprueba la solicitud.  
...
2. En el área de tareas, en el área **Autoservicio**, elija la ventana **Solicitudes para aprobar**.
