...
Para probar el flujo de aprobación, Pedro primero inicia sesión en [!INCLUDE[prod_short](includes/prod_short.md)] como Alicia y, a continuación, solicita aprobación de un pedido de compra. Después Sean inicia sesión como él mismo, ve la nota en su área de tareas, sigue el vínculo a la solicitud de aprobación del pedido de compra y aprueba la solicitud.  
