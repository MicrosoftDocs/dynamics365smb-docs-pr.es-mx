...
El área de tareas representa la página principal o la pantalla de inicio. Está diseñado para las necesidades de un rol específico en una organización. Dependiendo de su función, el Área de tareas le brinda una descripción general del negocio, su departamento o sus tareas personales. El área de tareas también lo ayuda a navegar por sus tareas diarias y encontrar el trabajo que tenga asignado.
...
El nombre de la empresa siempre se muestra en la esquina superior izquierda. Funciona como una acción que puede elegir para volver al área de tareas. Puede cambiar este nombre en la página **Información de empresa**.
...
Elija este enlace para ver o cambiar las notificaciones que recibe sobre ciertos eventos o cambios de estado. Puede, por ejemplo, obtener una notificación cuando va a facturar a un cliente que tiene una deuda vencida o cuando el inventario disponible es inferior a la cantidad que va a vender. Para obtener más información, consulte [Administrar notificaciones](ui-smart-notifications.md).
