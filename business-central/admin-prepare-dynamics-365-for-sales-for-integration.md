...
| **Procesar automáticamente cotizaciones de venta** | Procesar una cotización de venta en [!INCLUDE[prod_short](includes/prod_short.md)] cuando un usuario crea y activa una en [!INCLUDE[crm_md](includes/crm_md.md)]. |
