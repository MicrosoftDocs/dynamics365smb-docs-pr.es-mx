...
ms.author: edupont
---
## <a name="sign-up" />Registrarse

### <a name="which-email-address-i-should-use-to-sign-up" />¿Qué dirección de correo electrónico debo usar para registrarme?
...
### <a name="what-are-the-system-requirements-for-the-trial" />¿Cuáles son los requisitos del sistema para la evaluación?
...
### <a name="how-do-i-sign-up-for-the-trial-without-a-microsoft-365-tenant" />¿Cómo puedo registrarme para la prueba sin un inquilino de Microsoft 365?

No puede. Use una dirección de correo electrónico de su trabajo o escuela.

### <a name="can-i-sign-up-for-other-dynamics-365-apps-such-as-sales-marketing-and-customer-service" />¿Puedo registrarme en otras aplicaciones de Dynamics 365, como Sales, Marketing y Customer Service?
...
## <a name="trial-app" />Aplicación de evaluación

### <a name="i-didnt-receive-the-trial-details-email-after-signing-up-what-should-i-do" />No recibí el correo electrónico con los detalles de la evaluación después de registrarme, ¿qué debo hacer?
...
### <a name="how-do-i-add-more-users-to-a-trial" />¿Cómo agrego más usuarios a una evaluación?
...
### <a name="how-many-users-can-i-add-to-my-trial-environment" />¿Cuántos usuarios puedo agregar a mi entorno de evaluación?

Puede agregar un número ilimitado de usuarios al entorno de evaluación.

### <a name="how-do-i-reset-the-trial-environment" />¿Cómo restablezco el entorno de evaluación?
...
## <a name="trial-expiration-and-extension" />Vencimiento y evaluación de la prueba

### <a name="how-do-i-extend-the-trial" />¿Cómo amplío la evaluación?
