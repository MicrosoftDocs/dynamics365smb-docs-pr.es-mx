...
2. Para permitir que los usuarios cambien y vuelvan a enviar este informe, elija el campo **Modificar informes enviados**.  
...
5. Si desea configurar períodos de devolución de IVA, complete los campos **Versión del informe** y **Cálculo de recordatorio de período** en la sección **Período de devolución**.  

    En países donde las autoridades fiscales exigen períodos de devolución del IVA, como el Reino Unido, también debe completar los campos restantes. [!INCLUDE [tooltip-inline-tip_md](tooltip-inline-tip_md.md)]  
