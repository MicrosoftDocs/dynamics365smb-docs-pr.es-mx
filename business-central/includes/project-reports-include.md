...
| [Líneas de planificación de proyecto](https://businesscentral.dynamics.com?report=1006) |Este informe muestra las diferentes líneas de tareas y planificación del proyecto, incluido el tipo de línea, las cantidades, la unidad de medida, los costos totales, etc.|1006|
