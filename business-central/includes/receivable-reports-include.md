...
| **Clientes - Recepción de pagos** | 211 | Crea un recepción de pago para cada entrada del libro mayor de cliente del tipo **Pago**. Si el pago se ha aplicado a facturas, se especificarán las facturas; de lo contrario, solo indicará el monto del pago como no aplicado. Este reporte se utiliza para enviar a los clientes que desean documentación para recibir el pago.|
...
|**Lista de clientes**|101| Muestra información básica de distinta índole sobre los clientes, tal como grupo contable, grupo de descuento, intereses e información sobre pagos, representante, su moneda predeterminada, límite de crédito en su moneda local ($) y saldo actual (en $). Utilice el informe, por ejemplo, para mantener la información de la tabla Cliente.|
