...
ms.author: bholtorf
---
# <a name="setting-up-cash-flow-analysis"></a><a name="setting-up-cash-flow-analysis"></a><a name="setting-up-cash-flow-analysis"></a>Configuración del análisis de flujo de caja
...
## <a name="set-up-the-cash-flow-chart"></a><a name="set-up-the-cash-flow-chart"></a><a name="set-up-the-cash-flow-chart"></a>Configurar el gráfico Flujo de caja
...
## <a name="set-up-cash-flow-forecasts"></a><a name="set-up-cash-flow-forecasts"></a><a name="set-up-cash-flow-forecasts"></a>Configurar previsiones de flujo de caja
