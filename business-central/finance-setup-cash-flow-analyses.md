...
ms.author: bholtorf
---
# <a name="setting-up-cash-flow-analysis" />Configuración del análisis de flujo de caja
...
## <a name="set-up-the-cash-flow-chart" />Configurar el gráfico Flujo de caja
...
## <a name="set-up-cash-flow-forecasts" />Configurar previsiones de flujo de caja
...
## <a name="a-nameanchortextacreate-and-use-your-own-predictive-web-service-for-cash-flow-forecasts" /><a name="AnchorText"></a>Crear y usar su propio servicio web predictivo para las previsiones de flujo de caja
