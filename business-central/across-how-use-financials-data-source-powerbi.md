...
A partir de febrero de 2022, los nuevos informes que utilicen datos [!INCLUDE [prod_short](includes/prod_short.md)] se conectarán de manera predeterminada a una réplica de solo lectura de la base de datos [!INCLUDE [prod_short](includes/prod_short.md)]. En casos excepcionales, según el diseño de la página, podría aparecer un error cuando intente conectarse y obtener datos de la página.
