...
Antes de empezar, compruebe que se encuentra en la página Área de tareas del implementador de RapidStart Services.
...
2. Seleccione y abra el paquete que desea utilizar para migrar datos y después seleccione **Obtener tablas**. Se abre la ventana **Tomar tabla de paquete**.  
