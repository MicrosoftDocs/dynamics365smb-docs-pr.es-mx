...
<!-- 11 --> 
### <a name="is-it-possible-to-choose-which-business-central-environment-to-get-data-from-for-power-bi-for-example-like-a-sandbox-or-production-environment"></a>¿Es posible elegir el entorno de Business Central para obtener datos para Power BI, por ejemplo, un espacio aislado o un entorno de producción? 
...
### <a name="is-it-faster-to-get-data-using-api-pages-than-using-web-services"></a>¿Es más rápido obtener datos mediante las páginas de API que mediante los servicios web?
...
<!-- 19 -->
### <a name="loading-data-from-business-central-web-services-seems-slow-is-there-any-way-to-get-data-directly-from-the-sql-database-table"></a>La carga de datos desde los servicios web de Business Central parece lenta. ¿Hay alguna forma de obtener los datos directamente desde la tabla de la base de datos SQL?
