...
ms.author: edupont
---
# <a name="design-details-inventory-valuation"></a><a name="design-details-inventory-valuation"></a><a name="design-details-inventory-valuation"></a>Detalles de diseño: Valuación de Inventarios
...
## <a name="inventory-valuation-report"></a><a name="inventory-valuation-report"></a><a name="inventory-valuation-report"></a>Informe de valuación de inventarios
...
## <a name="inventory-valuation---wip-report"></a><a name="inventory-valuation---wip-report"></a><a name="inventory-valuation---wip-report"></a>Valuación de inventario - informe WIP
