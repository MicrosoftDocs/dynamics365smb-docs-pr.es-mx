...
Cuando la cantidad solicitada, como una línea de venta, supera la cantidad disponible en el inventario, aparece un mensaje para notificarle que existen productos sustitutos.
...
Si ha publicado una transacción para un artículo, no puede eliminar la ficha porque los movimientos pueden ser necesarias para la valuación de inventario o auditoría. Para eliminar fichas de producto con movimientos, póngase en contacto con el socio de Microsoft para hacerlo a través del código.  
