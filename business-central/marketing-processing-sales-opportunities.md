...
## Crear cotizaciones para oportunidades

> [!NOTE]
> Solo puede crear cotizaciones de venta a partir de oportunidades en las que el tipo de contacto sea Empresa.
...
Puede hacer pedidos ventas desde las cotizaciones ventas creadas para las oportunidades. Antes de poder crear órdenes de venta para sus contactos, debe crear el contacto como cliente. Para obtener más información, consulte [Crear contactos](marketing-create-contact-companies.md).
...
1. Elija el icono ![Bombilla que abre la función Dígame.](media/ui-search/search_small.png "Dígame qué desea hacer") Elija el icono , escriba **Administración de datos** y luego elija el vínculo relacionado.
...
Si una oportunidad sigue un ciclo de ventas, podrá moverla a la etapa posterior o anterior, e incluso saltar una etapa.
