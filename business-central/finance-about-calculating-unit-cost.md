...
---
# <a name="about-unit-cost-calculation" />Acerca del cálculo de costo unitario
...
## <a name="when-is-the-unit-cost-field-updated" />Cuando se actualiza el campo de costo unitario
