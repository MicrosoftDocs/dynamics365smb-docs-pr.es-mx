...
5. Seleccione el botón **Más información** para leer acerca de los escenarios que puede probar en un entorno aislado o seleccione el botón **Cerrar** para continuar con el área de tareas de su instancia aislada de [!INCLUDE[d365fin](includes/d365fin_md.md)].
