...
## <a name="use-financial-reporting-to-produce-financial-statements-and-kpis-related-to-purchasing"></a>Usar los informes financieros para elaborar estados de cuenta financieros y KPI (relacionados con las compras)
...
### <a name="show-purchasing-related-general-ledger-entries-and-balances-from-the-chart-of-accounts-page"></a>Mostrar los movimientos y balances de contabilidad general relacionados con las compras desde la página Catálogo de cuentas
...
Específicamente para compras, puede crear una vista en la página Catálogo de cuentas que solo muestre las cuentas que utiliza para registrar entradas de compras.
