...
## <a name="get-started-with-finance-capabilities"></a>Introducción a las funcionalidades financieras
...
| Configure y use informes financieros para crear resúmenes y estados de cuenta financieros y KPI | [Preparar informes financieros](bi-how-work-account-schedule.md) |
...
| Analice los datos financieros de su catálogo de cuentas. | [Analizar datos financieros del catálogo de cuentas](finance-general-ledger.md) |
...
| Analice el flujo de caja. | [Analizar el flujo de caja](finance-analyze-cash-flow.md) |
