...
9. Para revisar una factura de ventas registrada relacionada, elija la acción **Facturas venta/Abonos venta** .  
    ...
    Si existe más de una factura para este proyecto, debe elegir la factura correspondiente en la página **Facturas de proyecto** y luego elija la acción **Abrir factura de venta/Nota de crédito** .  
