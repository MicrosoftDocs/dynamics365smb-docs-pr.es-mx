...
1. Para el resultado, debe filtrar las cuentas que utiliza para esto; en los datos de demostración de Business Central, estas son cuentas que comienzan con "4", la configuración de su catálogo de cuentas puede ser diferente (si ejecuta el informe [Balance de comprobación por periodo](https://businesscentral.dynamics.com/?report=38), puede ver fácilmente qué cuentas se utilizan en su configuración). Establezca un filtro en las cuentas apropiadas en el menú **Filtros adicionales** (a la derecha, justo debajo del menú **Columnas**.)
