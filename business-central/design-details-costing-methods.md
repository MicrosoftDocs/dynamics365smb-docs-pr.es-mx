...
ms.author: bholtorf
---
# <a name="design-details-costing-methods" />Detalles de diseño: Métodos de costo
...
### <a name="effect-of-costing-methods-on-valuing-inventory-increases" />Efecto de los métodos de costo en la valoración de entrada de inventario
...
### <a name="effect-of-costing-methods-on-valuing-inventory-decreases" />Efecto de los métodos de costo en la valoración de salidas de inventario
