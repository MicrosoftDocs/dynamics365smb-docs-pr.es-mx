...
Además de comprar productos físicos (tipo de producto de **Inventario**), que afectan a la valuación de inventarios, puede comprar servicios representados por unidades de tiempo. Puede hacer esto con el tipo de elemento **Servicio** o con el tipo de línea **Recurso**.
