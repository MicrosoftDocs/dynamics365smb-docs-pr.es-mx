...
1. Elija el icono ![bombilla que abre la función Dígame](media/ui-search/search_small.png "Dígame que desea hacer"), escriba **Cotizaciones de venta** y luego elija el enlace relacionado.
...
14. En el campo **Importe descuento factura**, especifique un importe que se debe descontar del valor que aparece en el campo **Total impuesto incl.** en la parte inferior de la factura.
    ...
    > [!TIP]
    > Para que la **Cotización válida hasta fecha** se complete automáticamente con un número determinado de días después de la creación de la cotización, puede completar el campo **Cálculo de validez de la cotización** en la ventana **Ventas y cobros**. 
