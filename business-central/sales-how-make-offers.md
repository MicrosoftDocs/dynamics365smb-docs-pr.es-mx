...
2. En el campo **Cliente**, escriba el nombre de un cliente existente.
   ...
   Otros campos de la página **Cotización de venta** contienen información estándar del cliente seleccionado.  
...
12. Si el cliente acepta la cotización, seleccione la acción **Generar factura** o **Realizar orden**.
