...
|Avanzado|Publicación consolidada de recepción/envío para múltiples pedidos.<br /><br />Actividades de selección/ubicación consolidadas para múltiples documentos de origen.|Requerir recepción + Requerir ubicación,</br> Requerir envío + Requerir picking|Opcional. Controlado por el control de alternancia Código Bin es Obligatorio|Órdenes de compra -> Recepción de almacén -> Ubicación de almacén|Órdenes de venta -> Envíos de almacén -> Seleccionar hoja de trabajo -> Selecciones de almacén| Orden de producción -> Seleccionar hoja de trabajo -> Selecciones de almacén -> diario de consumo|
