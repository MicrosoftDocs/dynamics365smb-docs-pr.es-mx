...
Si los estados de cuenta financieros de una empresa se encuentran en una divisa diferente de la utilizada en la empresa consolidada, debe configurar tipos de cambio para la consolidación.  
...
Se crea una línea para cada cuenta, según la estructura del catálogo de cuentas. Una cuenta no aparece si todos los importes de la línea son 0. Para cada cuenta, se muestra la siguiente información:
