...
1. Seleccione el icono ![Bombilla que abre la característica Dígame](media/ui-search/search_small.png "Dígame qué desea hacer") Icono, ingrese  **Facturas de compra** (u otro documento de compra) y luego Seleccionar el vincular relacionado.
...
1. Seleccione el icono ![Bombilla que abre la característica Dígame](media/ui-search/search_small.png "Dígame qué desea hacer") Icono, ingrese  **Declaraciones de IVA** y luego Seleccionar el vincular relacionado.
