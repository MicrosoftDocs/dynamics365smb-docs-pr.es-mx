...
Si no ha definido una fecha de trabajo, la fecha actual se usará como la fecha de trabajo. Puede que desee utilizar una fecha de trabajo si tiene muchas operaciones con una fecha distinta a la activa.
