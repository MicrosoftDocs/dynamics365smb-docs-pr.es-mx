...
Independientemente de la configuración de **Registro activado**, algunas respuestas de Shopify siempre se registran para que pueda inspeccionarlas o descargarlas mediante la página **Lista de captura de datos**.
