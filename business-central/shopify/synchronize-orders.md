...
Cuando una orden de venta que se crea a partir de una orden de Shopify se envía, puede sincronizar los envíos con Shopify.
...
Si el documento **Remisión de venta registrada** contiene los datos de **Cód. transportista** o **N.º seguimiento bulto**, esta información se enviará a Shopify y al cliente final en el correo electrónico de confirmación de envío.
