...
El **Código de método de envío** para documentos de venta importados de Shopify, se puede rellenar automáticamente. Necesita configurar **Asignación de métodos de envío**.
...
Una vez completada la importación, puede explorar el pedido de Shopify y encontrar toda la información relacionada, como transacciones de pago, costos de envío, procesos de entrega, nivel de riesgo. También puede ver la confirmación del pedido enviada al cliente seleccionando la acción **Página de estado de Shopify**.

> [!NOTE]  
> Puede navegar a la ventana **Pedidos de Shopify** directamente y podrá ver pedidos con estado *abierto* de todas las tiendas. Para revisar los pedidos completados, debe abrir la página **Pedidos de Shopify** desde la ventana de **Ficha de tienda de Shopify** específica.
...
1. Vaya al icono ![Bombilla que abre la función Dígame](../media/ui-search/search_small.png "Dígame qué desea hacer") de búsqueda. , escriba **Sincronizar envíos con Shopify** y, a continuación, elija el vínculo relacionado.
...
Si el documento **Remisión de venta registrada** contiene **Cód. transportista** y/o **Nº seguimiento bulto**, esta información será enviada a Shopify y al cliente final en el correo electrónico de confirmación de envío.
