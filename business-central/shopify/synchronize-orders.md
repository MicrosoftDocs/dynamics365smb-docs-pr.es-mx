...
>[!Important]
>La ubicación, incluida la ubicación en blanco, definida en la línea de envío registrada, debe tener un registro coincidente en el almacén de Shopify. De lo contrario, esta línea no se devolverá a Shopify. Obtenga más información en [Asignación de almacén](synchronize-orders.md#location-mapping).
