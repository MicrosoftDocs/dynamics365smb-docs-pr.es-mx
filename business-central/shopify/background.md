...
- **Remisiones sin procesar**: las remisiones de venta registradas se originaron en pedidos de Shopify que no están sincronizados con Shopify.
- **Errores de remisiones**: el conector de Shopify no pudo sincronizar las remisiones de venta registradas con Shopify.
