...
* Al determinar un precio, [!INCLUDE[prod_short](../includes/prod_short.md)] utiliza la lógica del "precio más bajo". La lógica de precio más bajo significa que, si el precio unitario definido en la ficha de artículo es inferior al definido en el grupo de precios, se utiliza el precio unitario de la ficha de artículo.
