...
# <a name="the-image-analyzer-extension" />Extensión del analizador de imágenes
...
## <a name="switch-on-the-image-analyzer-extension" />Activar la extensión del analizador de imágenes
...
> [!NOTE]  
> Para activar la extensión del analizador de imágenes, debe ser administrador. Asegúrese de que se le ha asignado el conjunto de permisos de usuario **SUPER**. Para obtener más información, vea [Asignar permisos a usuarios y grupos](ui-define-granular-permissions.md).
...
## <a name="analyze-an-item-image" />Analizar una imagen de producto
...
| *Agregar a la lista negra* | Si el análisis sugiere un atributo que no desea ver, puede bloquearlo. Sin embargo, preste atención. Los atributos bloqueados ya no aparecerán más para otros productos. Si desea desbloquear un atributo, elija **Ver atributos bloqueados** y, a continuación, eliminarlo de la lista. |
...
## <a name="analyze-a-contact-person-picture" />Analizar una imagen de persona de contacto
...
## <a name="use-your-own-computer-vision-api-account" />Usar su propia cuenta de la API de Computer Vision
...
## <a name="see-how-many-analyses-you-have-left-in-the-current-period" />Ver cuántos análisis ha dejado en el período actual
...
## <a name="stop-using-the-image-analyzer-extension" />Detener el uso de la extensión del analizador de imágenes
