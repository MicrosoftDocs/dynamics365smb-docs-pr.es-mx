---
title: Acerca del cálculo del costo estándar
...
# <a name="about-calculating-standard-cost"></a>Acerca del cálculo del costo estándar
...
## <a name="set-up-standard-costs"></a>Establecer costos estándar
...
## <a name="update-standard-costs"></a>Actualizar los costes estándar
...
### <a name="post-inventory-cost-to-gl"></a>Regis. costo inventario en C/G
...
### <a name="roll-up-standard-cost"></a>Acumular el costo estándar
...
### <a name="implement-standard-cost-change"></a>Implementar cambio de costo estándar
