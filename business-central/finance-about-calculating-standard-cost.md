...
ms.author: edupont
---
# <a name="about-calculating-standard-cost" />Acerca del cálculo de costo estándar
...
## <a name="setting-up-standard-costs" />Configuración de los costos estándar
...
### <a name="material-costs" />Costos de materiales
...
### <a name="capacity-costs" />Costos de capacidad
...
### <a name="subcontractor-costs" />Costos de los subcontratistas
...
## <a name="updating-standard-costs" />Actualización de los costos estándar
