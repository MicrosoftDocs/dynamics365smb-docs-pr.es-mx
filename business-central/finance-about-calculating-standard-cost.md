...
ms.author: edupont
---
# <a name="about-calculating-standard-cost"></a><a name="about-calculating-standard-cost"></a><a name="about-calculating-standard-cost"></a>Acerca del cálculo de costo estándar
...
## <a name="setting-up-standard-costs"></a><a name="setting-up-standard-costs"></a><a name="setting-up-standard-costs"></a>Configuración de los costos estándar
...
### <a name="material-costs"></a><a name="material-costs"></a><a name="material-costs"></a>Costos de materiales
...
### <a name="capacity-costs"></a><a name="capacity-costs"></a><a name="capacity-costs"></a>Costos de capacidad
...
### <a name="subcontractor-costs"></a><a name="subcontractor-costs"></a><a name="subcontractor-costs"></a>Costos de los subcontratistas
...
## <a name="updating-standard-costs"></a><a name="updating-standard-costs"></a><a name="updating-standard-costs"></a>Actualización de los costos estándar
