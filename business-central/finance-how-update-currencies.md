...
Hay varios informes de la aplicación de contabilidad que se basan en movimientos de contabilidad. Para visualizar los datos financieros en el informe en la divisa adicional para informes, solo tiene que seleccionar el campo **Muestra en div. adic.** en la página de contabilidad correspondiente.  
