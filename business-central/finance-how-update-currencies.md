...
Los tipos de cambio son la herramienta para calcular el valor en divisa local ($) de cada transacción en moneda. La página **Tipos de cambio** incluye los siguientes campos:
