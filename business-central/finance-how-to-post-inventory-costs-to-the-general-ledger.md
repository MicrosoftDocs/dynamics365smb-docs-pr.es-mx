---
title: Conciliar los costos de inventario con el libro mayor
...
# <a name="reconcile-inventory-costs-with-the-general-ledger"></a>Conciliar los costos de inventario con el libro mayor
...
2. Puede registrar manualmente los costos de inventario en el módulo de contabilidad, si ejecuta el trabajo por lotes. Cuando lo ejecute, se crearán los movimientos de contabilidad según los movimientos de valoración. Puede publicar las entradas para que se resuman por grupo de publicación.
...
Si desea obtener una descripción general de qué valores se pueden registrar en el libro mayor sin realizar realmente la contabilización, puede ejecutar el trabajo por lotes  **Registrar costo de inventario en libro mayor**  sin registrar realmente los valores en el libro mayor. Para ello, deberá quitar la marca de verificación del campo **Registrar** en la página de solicitud. De esta manera, cuando se ejecuta el trabajo por lotes, se genera el informe que muestra los valores que están listos para registrarse en el libro mayor, pero no se registran.
...
- Muestra los importes de costos no conciliados en las entradas de valor en el libro mayor de inventario como si estuvieran asignados a cuentas relacionadas con el inventario correspondientes en el Libro mayor y los compara con los totales registrados en las mismas cuentas en el Libro mayor.
...
Las columnas **Inventario**, **Inventario (provisional)** e **Inventario WIP** muestran los totales facturados, no facturados y WIP de cada tipo de cuenta. Estos se calculan a partir de entradas de valor, es decir, se proyectan en los tipos de cuenta de mayor donde terminarán cuando finalmente se registren en el libro mayor.
