...
| Para | Vea |
| --- | --- |
| Cambiar la configuración básica como la empresa, la fecha de trabajo y el Área de tareas. |[Cambiar la configuración básica](ui-change-basic-settings.md) |
...
|Ver los videos de la funcionalidad seleccionada para obtener ayuda para empezar.|[Vídeos de tareas comunes](across-videos.md)|  
