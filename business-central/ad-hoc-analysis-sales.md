...
Después de introducir la información de un pedido de cliente y añadir todas las líneas del mismo, puede contabilizar el registro. El registro crea una remisión y una factura. [!INCLUDE [prod_short](includes/prod_short.md)] actualiza la cuenta del cliente, la cuenta contable y los movimientos de productos:
