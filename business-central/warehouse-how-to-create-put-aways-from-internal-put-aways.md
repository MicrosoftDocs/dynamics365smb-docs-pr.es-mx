...
5. Para rellenar las líneas con todo el contenido de la ubicación o el contenido filtrado de las ubicaciones de la ubicación, elija la acción **Obtener contenido de ubicación**.  
