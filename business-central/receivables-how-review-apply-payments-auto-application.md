...
7. Para aplicar una parte de un pago a una o más entradas abiertas que no existen en la base de datos, cree una nueva línea debajo de la línea de la misma cuenta. En el campo **Importe liquidado**, indique el importe pendiente de liquidar en la nueva línea y, a continuación, ajuste el campo **Importe liquidado** en la línea existente.
