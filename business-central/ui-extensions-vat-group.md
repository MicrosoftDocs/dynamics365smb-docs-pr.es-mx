...
1. En la esquina superior derecha, elija **Configuración** ![Configuración.](media/ui-experience/settings_icon_small.png "Icono de configuración para el Área de tareas") , y luego elija la acción **Configuración asistida**.
...
4. En el campo  **OAuth Punto final de autoridad 2.0**, introduzca `https://login.microsoftonline.com/common/oauth2`.
5. En el campo  **OAuth URL del recurso 2.0**, introduzca `https://api.businesscentral.dynamics.com/`.
6. En el campo  **OAuth URL de redirección 2.0**, ingrese `https://businesscentral.dynamics.com/OAuthLanding.htm`.
...
1. En la esquina superior derecha, elija el icono **Configuración** ![Configuración.](media/ui-experience/settings_icon_small.png "Icono de configuración para el Área de tareas") y, a continuación, elija la acción **Configuración asistida**.
2. Elija la acción **Configuración de gestión de grupos de IVA**.
