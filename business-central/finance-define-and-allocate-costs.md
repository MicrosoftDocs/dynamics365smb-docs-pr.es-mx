...
Este artículo describe cómo definir tres nuevos objetos de costo de destino de asignación para el centro de costo de fuente de asignación PROD utilizando la relación de asignación establecida 5:2:4. Los tres objetos de costo de destino son ACCESORIOS, PINTURA y COLOCACIONES.  
