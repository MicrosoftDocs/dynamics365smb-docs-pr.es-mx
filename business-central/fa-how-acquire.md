...
Puede agrupar los activos fijos en activos principales y sus componentes. Por ejemplo, es posible que tenga una máquina de producción que consta de varias piezas que desee agrupar de esta manera.  
...
El valor residual es el valor restante de un activo fijo cuando ya no se puede utilizar. Puede registrar el valor residual en el momento de registrar el costo de adquisición. Para obtener más información, vaya a [Depreciar o amortizar activos fijos](fa-how-depreciate-amortize.md).

Puede registrar el valor residual junto con el costo a partir del diario de activos.

> [!NOTE]
> Este proceso podría requerir que personalice la página Diarios de activos fijos al agregar el campo Valor residual. El campo Para no se muestra de forma predeterminada en la página. Para obtener más información, vaya a [Personalice su espacio de trabajo](ui-personalization-user.md).
