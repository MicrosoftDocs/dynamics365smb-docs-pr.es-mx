...
Como alternativa, puede convertir manualmente las cotizaciones de venta activadas desde [!INCLUDE[crm_md](includes/crm_md.md)] utilizando la acción **Procesar en [!INCLUDE[d365fin](includes/d365fin_md.md)]** en la página **Cotizaciones de venta - Dynamics 365 for Sales**.
