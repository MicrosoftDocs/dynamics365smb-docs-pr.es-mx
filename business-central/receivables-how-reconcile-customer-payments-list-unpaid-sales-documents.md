...
> [!NOTE]  
> Puede realizar las mismas tareas, incluidos los pagos a proveedores, en la página **Diario de conciliación de pagos**. Por ejemplo, puede importar estados de cuenta de banco, utilizar la aplicación automática y conciliar cuentas bancarias. Para obtener más información, vea [Conciliar pagos con liquidación automática](receivables-how-reconcile-payments-auto-application.md).
...
3. Rellene el resto de los campos de cada línea del diario general. Por ejemplo, proporcione el importe, el número de cliente o la información del estado de cuenta de banco. Para obtener más información, consulte [Registrar transacciones directamente en la contabilidad](finance-how-post-transactions-directly.md).  
