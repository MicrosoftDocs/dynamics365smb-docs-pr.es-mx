...
Por ejemplo, para que el catálogo de cuentas se rellene previamente con cuentas contables listas para usar. Por supuesto, puede cambiar el catálogo de cuentas para satisfacer sus necesidades. Obtenga más información en [Finanzas](finance.md).
...
| Configure el modo de asegurar, mantener y amortizar activos fijos, y el modo de registrar los costos de los activos fijos en los libros de la empresa. |[Configurar activos fijos](fa-setup.md) |
