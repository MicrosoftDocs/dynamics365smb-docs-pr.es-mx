...
---
# <a name="design-details-planning-parameters"></a><a name="design-details-planning-parameters"></a>Detalles de diseño: Parámetros de la planificación
...
## <a name="define-when-to-reorder"></a><a name="define-when-to-reorder"></a>Definir cuándo hacer la reorden
...
## <a name="define-how-much-to-reorder"></a><a name="define-how-much-to-reorder"></a>Definir qué cantidad de la reorden
...
## <a name="optimize-when-and-how-much-to-reorder"></a><a name="optimize-when-and-how-much-to-reorder"></a>Optimizar cuando se produzca la reorden y según la cantidad de reorden
