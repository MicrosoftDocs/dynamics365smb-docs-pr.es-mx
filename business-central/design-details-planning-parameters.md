...
---
# <a name="design-details-planning-parameters" />Detalles de diseño: Parámetros de la planificación
...
## <a name="define-when-to-reorder" />Definir cuándo hacer la reorden
...
## <a name="define-how-much-to-reorder" />Definir qué cantidad de la reorden
...
## <a name="optimize-when-and-how-much-to-reorder" />Optimizar cuando se produzca la reorden y según la cantidad de reorden
