...
Puede registrarse para obtener una versión de prueba [aquí](https://go.microsoft.com/fwlink/?linkid=847861). Le recomendamos que trabaje con [un distribuidor asociado](across-faq.md#findpartner) para ayudar a su organización a comenzar con [!INCLUDE[prod_short](includes/prod_short.md)].  
...
En [!INCLUDE[prod_short](includes/prod_short.md)], le serán familiares algunos aspectos, pero otros no. Cuando inicia sesión por primera vez en la empresa de demostración, obtiene acceso a una página de introducción con vínculos a guías de configuración asistida que pueden ayudarlo a empezar. Para obtener más información, vea [Preparación para hacer negocios](ui-get-ready-business.md).  
