...
En [!INCLUDE[prod_short](includes/prod_short.md)], le serán familiares algunos aspectos, pero otros no. Cuando inicia sesión por primera vez en la empresa de demostración, obtiene acceso a una página de introducción con enlaces a videos que pueden ayudarlo a comenzar. Para obtener más información, vea [Introducción a [!INCLUDE[prod_long](includes/prod_long.md)]](product-get-started.md).  
