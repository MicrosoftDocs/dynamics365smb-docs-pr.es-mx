...
ms.author: edupont
---
# <a name="adjust-item-costs"></a><a name="adjust-item-costs"></a>Ajustar precios de productos
...
## <a name="understanding-unit-cost-calculation"></a><a name="understanding-unit-cost-calculation"></a>Comprender el cálculo del costo unitario
...
### <a name="costing-method-fifo-lifo-specific-or-average"></a><a name="costing-method-fifo-lifo-specific-or-average"></a>Métodos de valuación de inventarios FIFO, LIFO, Especial o Medio
...
### <a name="costing-method-standard"></a><a name="costing-method-standard"></a>Método de valuación de inventarios Estándar
...
### <a name="all-costing-methods"></a><a name="all-costing-methods"></a>Todos los métodos de valuación de inventarios
