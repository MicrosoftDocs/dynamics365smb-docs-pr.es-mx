...
## <a name="to-set-up-fixed-asset-journal-templates" />Para configurar libros del diario de activos fijos
...
## <a name="to-set-up-fixed-asset-journal-batches" />Para configurar las secciones del diario de activos fijos
...
## <a name="to-set-up-fixed-asset-reclassification-journal-templates" />Para configurar los libros del diario de reclasificación de activos fijos
...
## <a name="to-set-up-fixed-asset-reclassification-journal-batches" />Para configurar las secciones del diario de reclasificación de activos fijos
...
## <a name="to-set-up-fixed-asset-class-codes" />Para configurar códigos de clase de activos fijos
...
## <a name="to-set-up-fixed-asset-subclass-codes" />Para configurar códigos de subclase de activos fijos
...
## <a name="to-set-up-fixed-asset-location-codes" />Para configurar códigos de ubicación de activos fijos
