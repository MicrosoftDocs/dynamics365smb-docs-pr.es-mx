...
ms.author: edupont
---
# <a name="set-up-bank-accounts"></a><a name="set-up-bank-accounts"></a><a name="set-up-bank-accounts"></a>Configurar bancos

Las cuentas bancarias se utilizan en [!INCLUDE[prod_short](includes/prod_short.md)] para hacer un seguimiento de las transacciones bancarias. Los bancos pueden expresarse en la divisa local (DL) o en una extranjera. Cuando haya configurado todos los bancos, puede utilizar también la opción de impresión de cheques. Las cuentas bancarias incluyen funcionalidad adicional para [conciliación de pagos](receivables-apply-payments-auto-reconcile-bank-accounts.md), [conciliación bancaria](bank-how-reconcile-bank-accounts-separately.md) y la importación y exportación de archivos bancarios. Las cuentas bancarias también se pueden incluir en transacciones en los diarios generales. Cada cuenta bancaria está vinculada a una cuenta en el catálogo de cuentas a través del grupo contable de la cuenta bancaria asignada. El uso de una cuenta bancaria en una transacción de pago creará automáticamente una entrada tanto en la cuenta bancaria como en la cuenta de contabilidad (G/L) conectada.  
...
- Si el código de divisa está en blanco
  ...
  Todas las transacciones en la cuenta bancaria se realizan en la divisa local ($) de la empresa actual. Si se realiza una transacción en la cuenta en otra moneda, los montos se contabilizan en la cuenta en $ según el tipo de cambio de la moneda correspondiente. Cualquier cheque que se emita desde esta cuenta debe emitirse en $. Si la cuenta bancaria se utiliza en un diario, la línea del diario heredará automáticamente el código de divisa en blanco.  
...
Por lo general, una cuenta bancaria se supervisa a diario para asegurarse de que los nuevos pagos de los clientes se registren lo más rápido posible. Esto ayuda a garantizar que el estado real de un cliente se refleje en [!INCLUDE[prod_short](includes/prod_short.md)]. Eso brinda a los vendedores, contadores y otros empleados acceso a la información más importante y actualizada para evitar realizar llamadas innecesarias al cliente con respecto a facturas vencidas o retrasos en los envíos.  
...
Puede crear tantas cuentas bancarias como necesite para su negocio. Para cada cuenta bancaria, debe especificar información que haga que la cuenta bancaria sea identificable de forma única. Esta información incluye la dirección geográfica del banco, las series numéricas para diferentes tipos de transacciones (como las transferencias directas de débito y crédito), la divisa en la que se especifican los importes y la información que se utiliza para importar estados de cuenta de banco. [!INCLUDE[tooltip-inline-tip](includes/tooltip-inline-tip_md.md)]
<!--
...
1. Elija el icono ![Bombilla que abre la función Dígame 2.](media/ui-search/search_small.png "Dígame qué desea hacer") , escriba **Cuentas bancarias** y luego elija el vínculo relacionado.
...
4. El *formato de importación de estados de cuenta bancarios* vincula la configuración de importación a la cuenta bancaria.
...
7. El *formato de importación de estados de cuenta bancarios* vincula la configuración de importación a la cuenta bancaria.
...
Para obtener una vista más condensada de sus cuentas de caja en los informes financieros, utilice las cuentas **Principio-Total** y **Fin-Total** en su catálogo de cuentas, las filas **Sumatorio** en informes financieros o las categorías de cuentas de contabilidad general. Más información en [Inteligencia empresarial y Financial Reporting](bi.md).
