...
- El código de divisa está en blanco
  ...
  Todas las transacciones en la cuenta bancaria se realizarán en la moneda local ($) de la empresa actual. Si se realiza una transacción en la cuenta en otra moneda, los montos se contabilizan en la cuenta en $ según el tipo de cambio de la moneda correspondiente. Cualquier cheque que se emita desde esta cuenta debe emitirse en $. Si la cuenta bancaria se utiliza en un diario, la línea del diario heredará automáticamente el código de divisa en blanco.  
...
1. Elija el icono ![Bombilla que abre la función Dígame 1.](media/ui-search/search_small.png "Dígame qué desea hacer") , escriba **Cuentas bancarias** y luego elija el enlace relacionado.
...
Puede crear tantas cuentas bancarias como necesite para su negocio. Para cada cuenta bancaria, debe especificar información que haga que la cuenta bancaria sea identificable de forma única. Esta información incluye la dirección geográfica del banco, series de números para diferentes tipos de transacciones, como adeudo directo y transferencias de crédito, la moneda en la que se especifican los montos y la información que se utiliza para importar estados de cuenta bancarios. [!INCLUDE[tooltip-inline-tip](includes/tooltip-inline-tip_md.md)]
<!--
...
1. Elija el icono ![Bombilla que abre la función Dígame 2.](media/ui-search/search_small.png "Dígame qué desea hacer") , escriba **Cuentas bancarias** y luego elija el enlace relacionado.
...
Para obtener una vista más condensada de sus cuentas de caja en los reportes financieros, utilice las cuentas **Inicio Total** y **Fin Total** en su catálogo de cuentas, las filas **Sumatorio** en estructuras de cuentas o categorías de cuentas de contabilidad. Para obtener más información, consulte la sección [Inteligencia empresarial y Financial Reporting](bi.md).
