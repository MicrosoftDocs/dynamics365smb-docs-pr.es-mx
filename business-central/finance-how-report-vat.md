---
title: Presentar informes de IVA a las autoridades fiscales
description: 'Aprenda a preparar informes que detallen el IVA de las ventas durante un período, o de las ventas y compras, y presente el informe a una autoridad fiscal.'
author: brentholtorf
ms.topic: conceptual
ms.devlang: al
...
# <a name="report-vat-to-tax-authorities"></a>Comunicar el IVA a las autoridades fiscales

Este artículo describe los informes que puede utilizar para enviar información sobre los montos del impuesto al valor agregado (IVA) correspondientes a las ventas y compras a las autoridades fiscales de su región. [!INCLUDE[prod_short](includes/prod_short.md)]  Dependiendo del país o región específicos, los informes pueden incluir información específica o puede haber informes adicionales que deba enviar. Consulte los artículos de su país o región en la sección [Funcionalidad local](about-localization.md).  
...
1. Elija el icono ![Bombilla que abre la función Dígame 2.](media/ui-search/search_small.png "Dígame qué desea hacer") , escriba **Conexiones de servicio** y luego elija el enlace correspondiente.
...
Opcionalmente, si su empresa no está ubicada en el Reino Unido, utilice la página  **Períodos de declaración de IVA**  para configurar declaraciones de IVA programadas. Si su empresa está ubicada en el Reino Unido, consulte  [Making Tax Digital in the United Kingdom (Impuestos digitales en el Reino Unido)](LocalFunctionality/UnitedKingdom/making-tax-digital-submit-vat-return.md).  
...
1. Elija el icono ![Bombilla que abre la función Dígame 3.](media/ui-search/search_small.png "Dígame qué desea hacer") Icono, ingrese **Lista de ventas CE** o **Declaraciones de IVA** y luego elija el vincular relacionado.  
...
| Aceptado | La declaración de IVA tiene este estado si el informe se marca como aceptado mediante la acción  **Marcar como aceptado** . Si el informe **Declaración de IVA** está marcado como **Aceptado**, puede ejecutar la acción **Calcular y contabilizar liquidación de IVA**. |
...
[Configurar cálculos y métodos de contabilización para el impuesto al valor agregado](finance-setup-vat.md)    
