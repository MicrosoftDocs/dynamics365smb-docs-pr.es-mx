...
Al transferir importes de IVA a la cuenta de liquidación, la cuenta de IVA de compras se acredita y la cuenta de IVA de ventas se debita con los importes calculados en el período. El importe neto se acredita o debita si el importe de IVA de compras es superior, en la cuenta de liquidación de IVA. Puede registrar la liquidación inmediatamente o imprimir primero un informe.  
