...
La persona responsable del envío ahora puede llevar los artículos al muelle de envío y registrar el envío, incluido el documento de origen relacionado, en la ventana de **Envío almacén**. Para obtener más información, consulte [Enviar productos](warehouse-how-ship-items.md).   
