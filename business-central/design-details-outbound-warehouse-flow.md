...
* Si sus procesos de selección y envío implican varias órdenes y requieren un mayor control y una visión general, puede optar por utilizar un documento de envío de almacén y un documento de selección de almacén para separar las tareas de selección y envío, métodos C y D.  
...
En cada línea de los productos que se han seleccionado o movido, parcial o totalmente, rellene el campo **Cantidad** y, a continuación, registre la selección de inventario. Los documentos de origen relacionados con el picking de inventario se registran como enviados o consumidos.  
...
Obtenga las líneas del documento de origen liberado en la página **Envío almacén**. Puede combinar líneas de varios documentos de origen en un envío de almacén.  

### <a name="3-create-a-warehouse-pick"></a>3: Crear un picking de almacén

En la página **Envío almacén**, cree actividades de selección de almacén para envíos de almacén de una de estas dos maneras:
...
- De forma pull, donde utiliza la acción **Liberar**. En la página **Hoja trabajo picking**, los empleados del almacén pueden usar la acción **Tomar documentos almacén** para obtener los pickings asignados. Cuando los picking de almacén están totalmente registrados, se eliminan las líneas en **Hoja trabajo picking**.
...
[Gestión almacén](design-details-warehouse-management.md)  
