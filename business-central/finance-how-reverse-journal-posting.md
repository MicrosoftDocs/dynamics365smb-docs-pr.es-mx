...
Para deshacer un registro de recepción o de remisión, antes de que se registre como facturado, puede usar la función **Deshacer** en el documento registrado. Puede deshacer cantidades de tipo **Producto**.
...
A continuación se describe cómo deshacer un histórico recepciones. Los pasos son parecidos para las remisiones registradas.
...
A continuación se describe cómo deshacer una remisión de devolución registrado y luego volver a publicar la devolución de la compra con una nueva cantidad.

1.  Elija el icono ![bombilla que abre la función Dígame](media/ui-search/search_small.png "Dígame que desea hacer"), escriba **Remisiones de devolución registradas** y luego elija el enlace relacionado.  
