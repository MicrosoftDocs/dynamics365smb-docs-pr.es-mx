...
> [!NOTE]  
> No olvide volver a calcular el costo estándar del producto desde la ficha **Producto**. Elija la acción **Fabricación**, la acción **Calcular costo estándar** y, luego, elija la acción **Todos los niveles**.  
