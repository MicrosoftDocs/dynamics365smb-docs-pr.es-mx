...
Como alternativa a la importación de estados de cuenta bancarios con el servicio de conversión de datos bancarios, puede utilizar el servicio Envestnet Yodlee Bank Feeds. Para obtener más información, vea [Configurar el servicio Envestnet Yodlee Bank Feeds](bank-how-setup-bank-statement-service.md).
