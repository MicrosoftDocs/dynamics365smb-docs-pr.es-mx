...
4. Comprobar si una orden de suministro existe en el registro actual de seguimiento de orden. En caso afirmativo, el sistema emite un mensaje de acción de tipo  *Cambio*  para aumentar el pedido.  
5. Comprobar que no exista una orden de suministro en el registro actual de seguimiento de orden. En caso afirmativo, el sistema emite un mensaje de acción de tipo  *Nuevo*  para crear un nuevo pedido.  
