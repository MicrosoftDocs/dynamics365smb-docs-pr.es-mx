...
2. Elija el icono ![Bombilla que abre la función Dígame.](media/ui-search/search_small.png "Dígame qué desea hacer") , escriba **Configuración de licencia** y luego elija el vínculo relacionado.  
...
En ambos casos, se aplican automáticamente varios ajustes de configuración. Estas configuraciones se enumeran en la segunda y tercera columnas de la tabla siguiente.
