...
Cuando se asigna una licencia de [!INCLUDE[d365fin](includes/d365fin_md.md)] a usuarios en Microsoft 365, estos pueden importarse a la página **Usuarios** en [!INCLUDE[d365fin](includes/d365fin_md.md)], mediante la acción **Obtener nuevos usuarios desde Office 365** .
