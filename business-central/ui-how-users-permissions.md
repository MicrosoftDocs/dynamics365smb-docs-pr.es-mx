...
Cuando se asigna una licencia de [!INCLUDE[d365fin](includes/d365fin_md.md)] a los usuarios en Office 365, se pueden importar en la página **Usuarios** en [!INCLUDE[d365fin](includes/d365fin_md.md)] mediante la acción **Obtener nuevos usuarios de Office 365**.
...
2. Dependiendo de lo que quiera hacer, elija la acción **Obtener nuevos usuarios de Office 365** o **Actualizar usuarios de Office 365**.
