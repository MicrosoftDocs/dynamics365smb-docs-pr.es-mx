...
Para definir los pasos del flujo de trabajo, rellene los campos de las líneas de flujo de trabajo con listas fijas de valores de evento y respuesta que representan los escenarios que admite el código de aplicación.<!--What are the "values"? Can we give an example?-->
