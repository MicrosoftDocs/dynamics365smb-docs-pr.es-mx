...
- Codeunit **Proveedor de resumen de página 2718** se publica como servicio web:
    ...
    Esta codeunit se publica como un servicio web de forma predeterminada. La codeunit es parte de la aplicación del sistema [!INCLUDE [prodshort](includes/prodshort.md)]. Se utiliza para obtener los datos de campo de una página de [!INCLUDE [prodshort](includes/prodshort.md)] agregada a una conversación de Teams. 
