...
1.  En [!INCLUDE[d365fin](includes/d365fin_md.md)], abra la empresa que servirá de línea base para la configuración, y abra el Área de tareas del implementador de RapidStart Services.  
...
1. Seleccione la acción **Obtener tablas**. Se abre la ventana de proceso **Obtener tablas de configuración**.  
