...
1.  En [!INCLUDE[prod_short](includes/prod_short.md)], abra la empresa que servirá de línea base para la configuración, y abra el Área de tareas del implementador de RapidStart Services.  
