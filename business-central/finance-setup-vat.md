...
## <a name="setting-up-vat-statement-templates-and-vat-statement-names"></a>Configurar plantillas de declaración de IVA y nombres de declaración de IVA
Las autoridades fiscales pueden modificar, y lo hacen, sus requisitos para registrar el IVA. **Plantillas de declaración de IVA** y **Nombres de declaración de IVA** puede ayudarle a prepararse para cambios próximos y hacer una transición sin problemas a los nuevos requisitos. Puede utilizar plantillas de declaración de IVA para definir los campos que desea incluir en su declaración de IVA, los que a su vez definen los cálculos, y puede crear un nuevo tipo de declaración de IVA cuando cambien los requerimientos. Por ejemplo, un tipo podría calcular el IVA para este año basándose en los requisitos actuales y otro podría calcular el IVA basándose en los requisitos para el próximo año. Las plantillas también son una forma de mantener un historial de los formatos de las declaraciones de IVA, por ejemplo, para que pueda consultar cómo calculó el IVA en años anteriores.

## <a name="how-to-define-and-preview-vat-statements"></a>Cómo definir y obtener una vista previa de las declaraciones de IVA
...
Para definir una declaración de IVA, realice los siguientes pasos:

1. Seleccione el icono ![Buscar página o informe](media/ui-search/search_small.png "icono Buscar página o informe"), escriba **Declaraciones de IVA** y, a continuación, seleccione el vínculo relacionado.  
...
Para obtener una vista previa de la declaración de IVA, realice los siguientes pasos:
