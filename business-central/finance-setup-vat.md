...
1. Elija el icono ![Bombilla que abre la función Dígame 1.](media/ui-search/search_small.png "Dígame qué desea hacer") y escriba **Configuración asistida**. 
...
### <a name="enable-or-disable-the-vat-date-feature"></a>Habilitar o deshabilitar la función Fecha de IVA
...
1. Elija el icono ![Bombilla que abre la función Dígame 1.](media/ui-search/search_small.png "Dígame qué desea hacer") , escriba **Configuración de usuario** y luego elija el enlace relacionado.  
2. En el campo **Id. de usuario**, especifique el usuario al que desea permitir publicar en un período específico.  
...
2. Elija el país o la región y. después. elija la acción **Formatos RFC/Curp**.
...
Puede configurar grupos de registro de IVA de negocio predeterminados deberá vincularlos a grupos contables de negocio. [!INCLUDE[prod_short](includes/prod_short.md)] asigna automáticamente el grupo de registro de IVA de negocio cuando asigna el grupo de registro de negocio a un cliente, proveedor o cuenta de contabilidad general.
...
1. Elija el icono ![Bombilla que abre la función Dígame 6.](media/ui-search/search_small.png "Dígame qué desea hacer") , escriba **Catálogo de cuentas** y, luego, elija el vínculo relacionado.  
2. Abra la **Ficha cuenta de C/G** de la cuenta.  
...
3. Seleccione el grupo de contabilización del IVA **.**  
...
1. Elija el icono ![Bombilla que abre la función Dígame 10.](media/ui-search/search_small.png "Dígame qué desea hacer") , escriba **Config. grupos registro IVA** y luego elija el enlace relacionado.  
2. En la columna **Código cláusula de IVA**, elija la cláusula que se utilizará para cada configuración de contabilización de IVA a la que se aplique.  

### <a name="to-specify-translations-for-vat-clauses"></a>Para especificar las traducciones de las cláusulas de IVA

1. Elija el icono ![Bombilla que abre la función Dígame 11.](media/ui-search/search_small.png "Dígame qué desea hacer") , escriba **Cláusulas de IVA** y luego elija el enlace relacionado.  
...
1. Elija el icono ![Bombilla que abre la función Dígame 12.](media/ui-search/search_small.png "Dígame qué desea hacer") , escriba **Grupos de registro IVA de producto** y luego elija el enlace relacionado.  
...
3. Elija el icono ![Bombilla que abre la función Dígame 13.](media/ui-search/search_small.png "Dígame qué desea hacer") , escriba **Config. grupos registro IVA** y luego elija el enlace relacionado.  
...
[Configurar plantillas de declaraciones de IVA y nombres de declaraciones de IVA](finance-how-setup-vat-statement.md)    
[Configurar el impuesto al valor agregado no realizado](finance-setup-unrealized-vat.md)    
...
[Verificar números de registro de IVA](finance-how-validate-vat-registration-number.md)    
...
[Informes de IVA en versión española](LocalFunctionality/Spain/vat-reports.md)    
