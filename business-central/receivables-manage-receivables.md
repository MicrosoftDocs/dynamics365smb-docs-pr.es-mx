...
Un paso habitual en cualquier ritmo financiero es conciliar las cuentas bancarias. Para cerrar facturas de venta y notas de crédito de compra como pagadas, aplique los pagos entrantes a los movimientos de clientes o proveedores.

Si bien la mayoría de los clientes en entornos B2B pagan después de la entrega y dejan las facturas de ventas publicadas abiertas para que el departamento de Cobros las cierre (aplique) cuando se recibe el pago, algunas facturas de ventas se pueden pagar de inmediato, por ejemplo con PayPal. Dichas facturas se liquidan inmediatamente como pagadas cuando se registran y, por lo tanto, no aparecen como pagos para procesar en Cuentas por cobrar. Para obtener más información, vea, por ejemplo [Facturar ventas](sales-how-invoice-sales.md).  
...
La página **Diario de conciliación de pagos** usa la lógica de conciliación automática que puede configurar en la página **Reglas de liquidación de pago**. Para obtener más información, consulte [Configurar reglas para la liquidación automática de pagos](receivables-how-set-up-payment-application-rules.md).  
...
| Para | Vea |
| --- | --- |
| Aplique pagos para abrir movimientos contables de clientes o proveedores basados en un archivo o una fuente de estado de cuenta de banco importado. Concilie la cuenta bancaria después de aplicar todos los pagos. |[Liquidación de pagos automáticamente y conciliación de cuentas bancarias](receivables-apply-payments-auto-reconcile-bank-accounts.md) |
