...
> [!TIP]
> Para ayudarlo a obtener una descripción general del progreso de emparejamiento, el campo **Emparejado con Dataverse** muestra si un registro está emparejado con una entidad de [!INCLUDE [cds_long_md](includes/cds_long_md.md)]. Puede usar el campo **Emparejado con Dataverse** para filtrar la lista de registros que está sincronizando.
...
## <a name="connecting-on-premises-versions"></a><a name="connecting-on-premises-versions"></a><a name="connecting-on-premises-versions"></a>Conexión a las versiones locales
