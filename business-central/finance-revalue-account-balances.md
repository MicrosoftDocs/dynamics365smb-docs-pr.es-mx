...
Si utiliza cuentas de libro mayor (G/L) para registrar partidas del balance en monedas extranjeras, debe revaluar los saldos de las cuentas antes de producir estados financieros. Los tipos de cambio de divisas cambian con frecuencia y la revalorización ayuda a que sus estados de cuenta financieros sean más precisos.
