...
|Área  |Funcionalidad  |
|---------|---------|
|**Contabilidad** |Finanzas básicas, Estructuras de cuentas, Activos fijos, Gestión bancaria, Conciliación de banco, Pagos, Débito directo, Dimensiones, Varias divisas, Presupuestos, Flujo de trabajo, Gestión de documentos/OCR, Consolidación, Empresas ilimitadas|
