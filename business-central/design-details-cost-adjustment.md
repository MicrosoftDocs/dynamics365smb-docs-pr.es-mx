...
ms.author: edupont
---
# <a name="design-details-cost-adjustment"></a><a name="design-details-cost-adjustment"></a>Detalles de diseño: Ajuste de costo
...
### <a name="average-cost-adjustment-entry-point"></a><a name="average-cost-adjustment-entry-point"></a>Punto de movimiento de ajuste de costo promedio
...
## <a name="manual-versus-automatic-cost-adjustment"></a><a name="manual-versus-automatic-cost-adjustment"></a>Ajuste de costo manual y automático
...
## <a name="adjust-cost---item-entries-batch-job"></a><a name="adjust-cost---item-entries-batch-job"></a>Proceso Valorar existencias - movs. producto
...
## <a name="automatic-cost-adjustment"></a><a name="automatic-cost-adjustment"></a>Ajuste automático del costo
