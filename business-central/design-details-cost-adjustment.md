...
ms.author: edupont
---
# <a name="design-details-cost-adjustment" />Detalles de diseño: Ajuste de costo
...
### <a name="average-cost-adjustment-entry-point" />Punto de movimiento de ajuste de costo promedio
...
## <a name="manual-versus-automatic-cost-adjustment" />Ajuste de costo manual y automático
...
## <a name="adjust-cost---item-entries-batch-job" />Proceso Valorar existencias - movs. producto
...
## <a name="automatic-cost-adjustment" />Ajuste automático del costo
