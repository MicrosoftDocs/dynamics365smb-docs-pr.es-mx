...
| Obtenga un mejor resumen al establecer los registros de documentos entrantes en *Procesado* para quitarlos de la vista predeterminada. |[Administrar varios registros de documentos entrantes](across-how-manage-many-income-document-records.md) |
