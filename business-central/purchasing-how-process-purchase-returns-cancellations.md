...
## <a name="to-create-a-purchase-credit-memo-from-a-posted-purchase-invoice" />Para crear una nota de crédito de compra desde una factura de compra registrada.
