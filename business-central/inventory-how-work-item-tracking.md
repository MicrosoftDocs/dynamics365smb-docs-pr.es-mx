...
Cuando se contabilizan líneas de recepción o envío de facturas o notas de crédito relacionadas, las líneas de seguimiento de artículos de los documentos de almacén se transfieren automáticamente. Sin embargo, se procesan de una manera especial.
...
En estos casos, las líneas de seguimiento de artículos se transfieren a la factura o a la nota de crédito, pero la página **Líns. seguim. prod.** no le permite cambiar los números de serie o de lote. Solo puede modificar las cantidades.  
...
1. Elija el icono ![Bombilla que abre la función Dígame.](media/ui-search/search_small.png "Dígame qué desea hacer") Icono, ingrese **Diarios de reclasificación de artículos** y luego elija el vincular relacionado.  
