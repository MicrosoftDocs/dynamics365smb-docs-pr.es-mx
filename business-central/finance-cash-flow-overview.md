...
# <a name="cash-flow-overview" />Descripción del flujo de caja
...
## <a name="definition-of-cash-flow" />Definición de flujo de caja
...
## <a name="making-a-cash-flow-forecast" />Realización de una previsión de flujo de caja
