...
---
# Registrar órdenes de servicio y notas de crédito
...
## Para registrar una nota de crédito de servicio  
...
4. Seleccione la acción **Registrar**. Si desea imprimir la nota de crédito al mismo tiempo que la registra, elija la acción **Registrar e imprimir** en su lugar.  
...
En el siguiente procedimiento se describe cómo registrar los productos, los costos o las horas de recursos empleados para una operación de servicio específica por la que no cobrará al cliente. Puede registrar productos, horas o costos consumidos solamente para un envío registrado que no tenga facturas o consumo registrados.  
...
El siguiente procedimiento muestra cómo registrar el envío de artículos de línea de servicio en almacenes en los que no se requiera control de almacén.  
...
Para obtener más información acerca del envío de los productos de línea de servicio en configuraciones avanzadas de almacén, vaya a [Picking de artículos para el envío de almacén](warehouse-how-to-pick-items-for-warehouse-shipment.md).  
...
1. Elija el icono ![Bombilla que abre la función Dígame.](media/ui-search/search_small.png "Dígame qué desea hacer") , escriba **Entregas de servicios registradas** y, a continuación, elija el vínculo relacionado.  
