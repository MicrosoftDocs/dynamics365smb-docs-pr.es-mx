...
## <a name="to-replace-the-assembly-item-with-its-components-on-document-lines" />Para sustituir el producto de ensamblado por sus componentes en líneas de documento
...
## <a name="to-calculate-the-standard-cost-of-an-assembly-item" />Para calcular el costo estándar de un producto de ensamblado
