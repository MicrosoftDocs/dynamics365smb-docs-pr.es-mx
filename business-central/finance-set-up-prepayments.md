...
## <a name="to-add-prepayment-accounts-to-the-general-posting-setup" />Para agregar cuentas de anticipo a la configuración de grupos contables
...
## <a name="to-set-up-number-series-for-prepayment-documents" />Configurar números de serie para documentos de anticipo
...
## <a name="to-set-up-prepayment-percentages-for-items-customers-and-vendors" />Definir porcentajes de anticipo para productos, clientes y vendedores
...
### <a name="to-determine-which-prepayment-percentage-has-first-priority" />Para determinar qué porcentaje de anticipo tiene prioridad
...
## <a name="to-automatically-release-sales-orders-when-prepayments-are-applied" />Para liberar automáticamente pedidos de venta cuando se aplican anticipos
