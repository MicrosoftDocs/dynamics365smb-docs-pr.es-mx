...
# <a name="review-amounts-in-general-ledger-accounts" />Revisar importes en cuentas del libro mayor
...
## <a name="set-up-accounts-for-reviews" />Configurar cuentas para revisiones
...
## <a name="mark-entries-as-reviewed" />Marcar movimientos como revisados
...
## <a name="review-accounts-that-have-old-entries" />Revisar cuentas que tienen movimientos antiguos
...
## <a name="filter-entries" />Filtrar movimientos
...
## <a name="analyze-entries" />Analizar movimientos
