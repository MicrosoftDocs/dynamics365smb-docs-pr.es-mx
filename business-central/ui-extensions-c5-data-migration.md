...
### <a name="chart-of-accounts"></a>Catálogo de cuentas

* Dimensiones estándar: departamento, centro de costo, propósito  
...
Si algo sale mal y se produce un error, el campo **Estado** muestra **Completado con errores** y el campo **Recuento de errores** mostrará la cantidad de errores. Para ver una lista de los errores, puede abrir la página **Errores de migración de datos** si elige:  
