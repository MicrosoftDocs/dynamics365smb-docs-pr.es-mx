...
Según sus datos migrados, ahora puede empezar a crear nuevos documentos de compra o venta. Use la sección **Mi empresa** de la ventana **Inicio** para crear rápidamente una nueva cotización de venta, factura de venta, pedido de venta, factura de compra o registro de venta.
