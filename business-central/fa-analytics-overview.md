...
## Usar los informes financieros para elaborar estados de cuenta financieros y KPI relacionados con activos fijos
...
### Mostrar movimientos de contabilidad general y saldos del libro mayor de activos fijos desde la página Catálogo de cuentas
...
Específicamente para activos fijos, puede crear una vista en la página Catálogo de cuentas que solo muestre las cuentas que utiliza para registrar entradas de activos fijos.
