...
- Realizar un seguimiento de los datos financieros con informes financieros personalizados para flujo de caja, ingresos, balances, activos fijos, estructura de capital, indicadores clave de rendimiento y mucho más.
...
- Cree cuentas y gestione procesos complejos relacionados con una gama de actividades comerciales, incluida la valuación de inventarios, las divisas extranjeras, los informes de segmentos y las salidas de los PCGA (principios de contabilidad generalmente aceptados) locales.
