...
- Realizar un seguimiento de los datos financieros a través de estructuras de cuentas personalizadas para el flujo de caja, ingresos, balances generales, activos fijos, estructura de capital, indicadores clave de rendimiento y mucho más.
...
### <a name="tailor-account-schedules-to-your-needs"></a>Adaptar las estructuras de cuentas a sus necesidades
...
- Cree cuentas y maneje procesos complejos relacionados con un espectro de actividades comerciales, incluida la valuación de inventarios, las monedas extranjeras, los informes de segmentos y las salidas de los PCGA locales.
