...
> [!NOTE]  
>  El sistema de planificación puede haber consumido el stock de seguridad intencionadamente y, a continuación, lo repondrá de forma inmediata. Para obtener más información, consulte la sección "El inventario de seguridad se puede consumir" en [Detalles de diseño: Carga de los perfiles de inventario](design-details-loading-the-inventory-profiles.md).
