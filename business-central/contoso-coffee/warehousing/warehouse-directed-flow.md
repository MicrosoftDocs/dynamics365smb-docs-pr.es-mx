...
5. Registrar el almacenamiento de almacén
    ...
    - Una línea de lugar que mueve una BOLSA a una de las ubicaciones fijas configuradas (W-05-0001)
    - Una línea de lugar que mueve otra BOLSA a otras ubicaciones fijas (W-05-0002). Esto se debe a que la ubicación fija única no puede contener la cantidad total de la recepción.
