...
description: Describe cómo conciliar pagos usando la liquidación automática para liquidar pagos o recepciones de efectivo en los movimientos pendientes relacionados.
author: brentholtorf
ms.topic: conceptual
ms.devlang: al
...
6. Si se ha habilitado el servicio Envestnet Yodlee Bank Feeds, en la página **Filtro de estado de cuenta de banco** que se abre automáticamente, especifique el intervalo de fechas para que se importen los estados de cuenta de banco.
    ...
    Las reglas controlan si las liquidaciones automáticas, las calidades de coincidencia y si las líneas requieren revisión. Puede editar las reglas para ajustar los resultados. Para obtener más información, consulte [Configurar reglas para la liquidación automática de pagos](receivables-how-set-up-payment-application-rules.md).
