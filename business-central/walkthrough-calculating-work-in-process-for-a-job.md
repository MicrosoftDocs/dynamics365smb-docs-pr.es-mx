...
## <a name="story"></a>Historia
 ...
 Este tutorial se centra en la empresa CRONUS España S.A., una empresa de diseño y consultoría que diseña y ajusta nuevas infraestructuras, (como salas de conferencias y oficinas) con mobiliario, accesorios y unidades de almacenamiento. La mayor parte del trabajo en CRONUS está orientado al proyecto y Tricia, un miembro del equipo de proyecto, utiliza los proyectos para tener una visión general de cada proyecto en curso que CRONUS ha iniciado y también los proyectos que se han completado. Algunos de los proyectos pueden ser largos y pueden durar varios meses. Tricia puede usar una cuenta WIP para registrar el trabajo en curso y realizar el seguimiento de los costos del proyecto.  

## <a name="calculating-wip"></a>Cálculo de WIP

 CRONUS ha contratado un proyecto extenso que ahora se ha ampliado a varios periodos de registro. Tricia, un miembro de equipo de proyecto, calcula el trabajo en proceso (WIP) para garantizar que el informe financiero de la empresa sea preciso.  
...
|**Excluido**|Se aplica sólo a una tarea con el **Tipo tarea proyecto** de **Registro**. La tarea no se incluye cuando se calcula el WIP y el reconocimiento.|  
 ...
 En el siguiente tutorial, Tricia aplica el método Valor de costo, su estándar de la empresa, para calcular el trabajo en proceso (WIP). Tricia especifica la parte del proyecto que se incluirá en el cálculo de WIP, asignando los valores WIP-Total a diversas líneas de tareas del proyecto.  
...
2. En la lista **Proyectos**, seleccione el proyecto **Reno** y, después, seleccione **Editar**. Se abre la ficha de proyecto en modo edición.  
     ...
     WIP se puede calcular basándose en Valor costo, Valor venta, Costo ventas, Porcentaje completado o Contrato completado. En este ejemplo, CRONUS utiliza el método de Valor del costo.  
...
10. En la página **Ficha de proyecto**, expanda la ficha desplegable **Trabajo en curso y reconocimiento** para ver los valores calculados. También puede ver la **Fecha registro WIP** y los valores que se han registrado en la contabilidad general, si existe.  
 ...
 Observe que el valor de **Importe costos reconoc.** es 215,60 en la columna **Para registrar**. Esto refleja los costos totales de dos de los productos en el grupo de las tareas 1110 - 1130 del proyecto. El tercer producto se estableció en **Excluido** y, por lo tanto, no se incluye en el cálculo del WIP.  
