...
|**Excluido**|Se aplica sólo a una tarea con el **Tipo tarea proyecto** **Registro**. La tarea no se incluye cuando se calcula el WIP y el reconocimiento.|  
 ...
 En el siguiente tutorial, Tricia aplica el método Valor de costo, su estándar de la empresa, para calcular el trabajo en proceso (WIP). Tricia especifica la parte del trabajo que se incluirá en el cálculo de WIP, asignando los valores WIP-Total a diversas líneas de tareas del proyecto.  
