...
En las líneas de orden, el precio unitario se actualizará para todas las líneas de tipo de producto y recurso, si se utilizan precios con IVA incluido para el producto. Para otros tipos de línea, es posible decidir si el precio unitario se debe actualizar o no.
