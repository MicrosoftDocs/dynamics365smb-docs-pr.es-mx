...
## <a name="to-create-tasks-for-a-project"></a>Facturar a un cliente por varias tareas del proyecto
...
## <a name="invoice-one-or-more-customers-for-project-tasks"></a>Para crear una ficha de proyecto
...
## <a name="specify-a-default-location-for-project-items"></a>Para crear tareas para un proyecto
...
| Tipo | Descripción |
| --- | --- |
| **Ppto** |Proporciona consumo y costos del proyecto estimados, habitualmente en un contrato de tiempo y tipo de proyecto. Las líneas de planificación de este tipo no pueden facturarse. |
...
> [!NOTE]
> A medida que introduzca información en las líneas de planificación del proyecto, la información de costos se completará automáticamente. Por ejemplo, el costo, el precio y el descuento de los recursos y los productos se basarán en la información de los recursos y productos.
