...
> [!Note]
> Esta funcionalidad sirve para reponer artículos de ventas en su propio inventario. Para comprar productos para la entrega directa de su proveedor a su cliente, debe crear una remisión directa. Para obtener más información, vea [Realizar envíos directos](sales-how-drop-shipment.md).   
