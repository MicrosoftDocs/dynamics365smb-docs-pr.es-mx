...
ms.author: edupont
---
# <a name="walkthrough-making-cash-flow-forecasts-using-financial-reports" />Tutorial: elaboración de previsiones del flujo de caja con informes financieros
...
## <a name="view-and-print-the-cash-flow-forecast" />Ver e imprimir la previsión del flujo de caja
