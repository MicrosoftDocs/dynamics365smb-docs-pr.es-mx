...
Ken es un controlador de CRONUS que efectúa previsiones mensuales del flujo de caja. Incluye las finanzas, las ventas, las compras y los activos fijos en la previsión y, a continuación, lo envía a la directora financiera, Sara, para una perspectiva de negocio.  
...
Antes de que Ken pueda imprimir la previsión del flujo de caja, necesita crear la definición de columna para la información numérica. En las columnas, define la información que desea utilizar de las líneas.
