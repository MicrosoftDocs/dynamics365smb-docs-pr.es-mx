...
1. Elija el icono ![Bombilla que abre la función Dígame.](media/ui-search/search_small.png "Dígame qué desea hacer") Icono, ingrese a **Lista de informes Intrastat** y seleccione el vincular relacionado.
...
* El **Tipo de publicación de activos fijos** en el campo **Entrada del libro mayor de activos fijos** es **Costo de adquisición** y si el **Tipo de documento** es **Factura** en el caso de compras, y
...
> [!NOTE]  
> Si la empresa opera desde más de un país/región, los informes de intrastat no funcionan para todos los países/regiones donde están configuradas las ubicaciones. Los informes se basan únicamente para el país/región principal, ya que actualmente no es posible utilizar informes para varios países/regiones.  

### <a name="triangular-trade-in-intrastat"></a>Comercio triangular en Intrastat

El comercio triangular implica el comercio entre tres países o regiones donde los bienes pasan por alto el país/región de la empresa informante. En Business Central, esto se puede facilitar a través de la funcionalidad [Envío directo](sales-how-drop-shipment.md). Para habilitar esta opción, active el campo **Incluir envío directo** en la **Configuración de informe Intrastat**.  

Cuando habilita esta opción, el sistema usa las siguientes reglas, pero solo si tiene la opción **Envío directo** marcada en el **Pedido de venta**: 
