...
Si recibió el mensaje de error *El "peso total" de la línea de informe de intrastat no debe estar en blanco*, probablemente se deba a que no configuró el campo **Peso neto** en el origen, artículo o activo fijo utilizado. En este caso, busque la ficha del artículo o el activo fijo y agregue el valor requerido. Después de eso, solo necesita volver a abrir el **Informe de Intrastat** y seguir estos pasos:
