...
3. Como ambas opciones tienen el mismo proceso, abrirá la página **Coincidencia de pedidos de compra** con el siguiente contenido: 
    ...
    9. Si comete un error, puede elegir la acción **Eliminar conciliación** para eliminar las líneas coincidentes en el lado del pedido de compra o elegir la acción **Restablecer coincidente** para restablecer todo lo que coincide. 
...
2. Desea permitir una tolerancia en el campo **% diferencia coincidente doc. elect.** especificando el porcentaje máximo permitido de diferencia de costos al cotejar una línea **Documento electrónico** con la línea **Pedido de compra**. 
...
##### <a name="matching-lines-from-e-document"></a>Coincidente de líneas de un documento electrónico
...
### <a name="e-document-matching-assistance-copilot"></a>Copiloto de ayuda de coincidente de documentos electrónicos

> [!NOTE]
> Actualmente el **Copiloto de ayuda de coincidente de documentos electrónicos** se encuentra en estado de versión preliminar listo para producción y está disponible en todo el mundo, excepto en Canadá. Solo funciona en inglés. 
...
En caso de que no haya activado el copiloto de **Ayuda de coincidente de documentos electrónicos**, deberá hacerlo manualmente. Para habilitar el copiloto de **Ayuda de coincidente de documentos electrónicos**, siga estos pasos: 
...
#### <a name="use-the-e-document-matching-assistance-copilot"></a>Usar el copiloto de ayuda de coincidente de documentos electrónicos
...
2. Observe que la solicitud **Líneas de pedido de coincidente de documentos electrónicos con Copilot** está funcionando y la página **Coincidencia de pedidos de compra** está en segundo plano. Eso significa que está ocurriendo el mismo proceso pero con el apoyo automático de **Copilot**, que ejecuta el proceso de coincidencia en su lugar. 
3. Después de unos segundos, la **Líneas de pedido de coincidente de documentos electrónicos con Copilot** sugerirán líneas para coincidir con algunos detalles adicionales: 
    ...
    1. En el encabezado del mensaje, puede encontrar la siguiente información: 
       ...
       |Importe total con IVA coincidente | Especifica el importe conciliado con IVA. |
...
4. Si no está satisfecho con la mayoría de las sugerencias, o si no desea utilizar la característica **Líneas de pedido de coincidente de documentos electrónicos con Copilot**, seleccione **Descartarlo** y podrá continuar con el coincidente manual como se explicó anteriormente.  
...
7. Ahora puede continuar trabajando mientras realiza el coincidente manual; eso significa que puede eliminar coincidencias, conciliar manualmente o restablecer las coincidencias. Si no desea realizar cambios, simplemente elija la acción **Aplicar a pedido de compra** y continúe trabajando con el **Pedido de compra**. 
