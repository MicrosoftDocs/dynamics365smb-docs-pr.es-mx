...
|Obtengan información sobre el rendimiento de sus actividades empresariales mediante presupuestos, estructuras de cuentas y vistas de análisis.|[Inteligencia empresarial financiera](bi.md)|
...
|Registrar nuevo inventario o productos de tipo servicio, clasificar productos para facilitar la búsqueda, ajustar los niveles de inventario y llevar a cabo tareas comunes de valoración de inventario.|[Grupos contables inventario](inventory-manage-inventory.md)|
...
|Permitir a los usuarios intercambiar datos con orígenes externos durante las tareas diarias, como envío/recepción de documentos electrónicos, importación y exportación de archivos bancarios y actualización de tipos de cambio de divisa.|[Intercambio de datos en forma electrónica](across-data-exchange.md)|
