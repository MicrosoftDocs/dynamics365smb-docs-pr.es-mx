...
ms.author: bholtorf
---
# <a name="design-details-average-cost" />Detalles de diseño: costo promedio
...
## <a name="setting-up-average-cost-calculation" />Configurar el cálculo del costo promedio
...
## <a name="calculating-average-cost" />Cálculo de costo promedio
...
### <a name="example-average-cost-period--day" />Ejemplo: Periodo de costo promedio = Día
...
### <a name="example-average-cost-period--month" />Ejemplo: Periodo de costo promedio = Mes
...
## <a name="recalculating-average-cost" />Nuevo cálculo de costo promedio
...
### <a name="example-of-recalculated-average-cost" />Ejemplo de costo promedio recalculado
