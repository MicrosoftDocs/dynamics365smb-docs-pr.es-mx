...
11. En la lista de plantillas disponibles, seleccione una de las plantillas y, a continuación, elija **Crear**.  
    ...
    - *Solicitar aprobación para cotización de venta de Microsoft [!INCLUDE[prod_long](includes/prod_long.md)]*
    - *Solicitar aprobación para factura de venta de Microsoft [!INCLUDE[prod_long](includes/prod_long.md)]*,
    - *Solicitar aprobación para nota de crédito de venta de Microsoft [!INCLUDE[prod_long](includes/prod_long.md)]*
    ...
    - *Solicitar aprobación para nota de crédito de compra de Microsoft [!INCLUDE[prod_long](includes/prod_long.md)]*  
...
Al crear un nuevo flujo de Power Automate mediante un desencadenador de aprobación de [!INCLUDE[prod_short](includes/prod_short.md)], como *Cuando se solicite la aprobación de un documento de compra*, recibe un mensaje de error similar al siguiente:
