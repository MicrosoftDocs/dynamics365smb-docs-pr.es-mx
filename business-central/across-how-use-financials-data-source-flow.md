...
11. En la lista de plantillas disponibles, seleccione una de las plantillas y, a continuación, elija **Crear**.  
    ...
    *Solicitar aprobación para la cotización de venta de Microsoft [!INCLUDE[prod_long](includes/prod_long.md)]*,  
    *Solicitar aprobación para factura de venta de [!INCLUDE[prod_long](includes/prod_long.md)]*,  
    *Solicitar aprobación para la nota de crédito de venta de Microsoft [!INCLUDE[prod_long](includes/prod_long.md)]*,  
