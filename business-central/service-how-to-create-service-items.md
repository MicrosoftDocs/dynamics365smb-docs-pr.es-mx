...
- **Bloquear** o **Hacer contrato** en la página **Cotización de contrato de servicio**.
...
- **Convertir en pedido** en la página **Cotización de servicio**.
- **Liberar para enviar** o **Registrar** en la página **Orden de servicio**.
- **Registrar** en la página **Factura servicio**.
...
- **Bloquear** y **Convertir en contrato** en la página **Cotización de contrato de servicio** (si está bloqueada para contrato de servicio, o todos).
...
- **Convertir en pedido** en la **Cotización de servicio** (si está bloqueado para todos).
...
- **Registrar** en la página **Factura servicio** (si está bloqueado para todos).
