...
Si elige la casilla **Precios con IVA incluido** en un documento de ventas, los campos **Precio unitario** e **Importe de línea** incluirán el IVA. De forma predeterminada, los valores de estos campos no incluyen el IVA. Los nombres de los campos reflejan si los precios incluyen IVA.  
