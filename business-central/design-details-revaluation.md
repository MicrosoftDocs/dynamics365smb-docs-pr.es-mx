...
## <a name="expected-cost-in-revaluation"></a>Costo previsto en revalorización
...
1.  Se registran los eslabones comprados como recibidos con un costo unitario de 2,00 $.  
2.  Se registra una revalorización de los eslabones con un nuevo costo unitario de 3,00 $, con lo que se actualiza el costo estándar a 3,00 $.  
...
|Paso|Fecha de registro|Tipo mov.|Fecha valoración|Importe costo (Esperado)|Importe costo (Real)|Nº mov. producto|Nº mov.|  
|----------|------------------|----------------|--------------------|------------------------------|----------------------------|---------------------------|---------------|  
...
|3.c.|15-01-20|Variación|15-01-20|0.00|450,00|1|5|  
...
Use la fecha del registro o de la revalorización para determinar si una salida de existencias está afectada por una revalorización.  
...
|Escenario|N.º mov.|Tiempo|Afectado por revalorización|  
|--------------|---------------|------------|-----------------------------|  
...
5.  El 01-03-20, calcula el valor de inventario del producto y registra una revalorización del costo unitario del producto de 10,00 $ a 8,00 $.  
...
Solo puede realizar una revaluación al final del período seleccionado en el campo **Periodo costo promedio** en la página **Configuración de inventario**.
...
Este ejemplo muestra lo que sucede cuando calcula el valor de inventario en la página **Diario de revalorización de productos** . En la página **Configuración de inventario**, **Producto** se elige en el campo **Tipo cálculo costo prom.** y **Mes** se elige en el campo **Periodo costo promedio**.

La siguiente tabla muestra movimientos de productos para el artículo de costo medio de muestra, ITEM1.

|Fecha de registro|Tipo mov. producto|Cantidad|Importe de costo (real)|N.º mov.|
|----|----|----|----|----|
25-04-23|Compras|5|5.00|1
26-04-23|Compras|3|3.00|2
27-04-23|Venta|-5|-5,00|3
28-04-23|Venta|-1|-1,00|4
13-05-23|Compras|2|20,00|5
