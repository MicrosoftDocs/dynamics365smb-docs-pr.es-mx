...
> [!TIP]
> Use estructuras de cuentas para obtener información sobre los datos financieros almacenados en su catálogo de cuentas. Para obtener más información, vea [Preparar informes financieros con estructuras de cuentas y categorías de cuentas](bi-how-work-account-schedule.md).
