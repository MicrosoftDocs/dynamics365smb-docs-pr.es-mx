...
12. En el campo **Cód. unidad de medida**, especifique la unidad de tiempo en la que se efectúa el cálculo de costos y la planeación de capacidad del centro de trabajo.
...
17. En el campo **Tiempo espera en cola**, puede especificar el intervalo de tiempo fijo que debe transcurrir antes de que se inicie el trabajo asignado en este centro de trabajo. 
