...
ms.author: edupont
---
# <a name="create-service-quotes"></a><a name="create-service-quotes"></a><a name="create-service-quotes"></a>Crear cotizaciones de servicio
...
## <a name="to-create-a-service-quote"></a><a name="to-create-a-service-quote"></a><a name="to-create-a-service-quote"></a>Para crear una cotización de servicio
