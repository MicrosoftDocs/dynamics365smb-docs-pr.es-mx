...
|Utilice los pagos por adelantado para administrar los pagos parciales de ventas y compras. <!-- **Requires complete sample data** --> |[Tutorial: Configuración y facturación de anticipos de ventas](walkthrough-setting-up-and-invoicing-sales-prepayments.md)|  
...
|Informar de los costos de un proyecto. <!-- **Requires complete sample data** --> |[Tutorial: cálculo del trabajo en curso para un proyecto](walkthrough-calculating-work-in-process-for-a-job.md)|  
|Picking de productos para remisión en configuraciones de almacén básico. <!-- **Requires complete sample data** --> |[Tutorial: picking y envío en la configuración del almacenamiento básico](walkthrough-picking-and-shipping-in-basic-warehousing.md)|  
