...
2. Cree una nueva línea en la página **Config. usuario aprobación** y después rellena los campos tal y como se describe en la tabla siguiente.  
   ...
   |**Importe límite aprob. ventas**|Especifique el importe máximo de ventas en divisa local ($) que la persona identificada en el campo **ID. de usuario** puede aprobar.|
