---
title: 'Procedimiento: agrupamiento de remisiones en una factura única | Microsoft Docs'
...
5. Seleccione la línea de envío que desee incluir en la factura:  
    ...
    Si se ha seleccionado una línea de remisión incorrecta o desea volver a empezar, tiene que eliminar las líneas de la factura y volver a ejecutar la función **Tomar líneas env. venta**.  
