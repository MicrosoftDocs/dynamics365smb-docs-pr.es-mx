...
Este tutorial se centra en CRONUS, que es una empresa ficticia de diseño y consultoría que diseña y adapta nuevas infraestructuras. Por ejemplo, salas de conferencias y oficinas con muebles, complementos y unidades de almacenamiento. La mayor parte de su trabajo está orientado a los proyectos. Prakash, un administrador de proyectos de CRONUS utiliza proyectos para obtener un panorama de cada tarea en curso que CRONUS ha iniciado y completado. Prakash normalmente es uno de los que trata con los clientes y se introduce el núcleo del trabajo, que son líneas de tareas y de planificación, además de los precios, en [!INCLUDE[prod_short](includes/prod_short.md)]. Prakash observa que crear, mantener y revisar la información es directo. Prakash también considera positiva la forma en que [!INCLUDE[prod_short](includes/prod_short.md)] activa copiar los proyectos y el pago por plazos.
 ...
 Tricia, miembro del equipo del proyecto que depende de Prakash, es la responsable de supervisar el día a día del proyecto. Tricia especifica el trabajo realizado por técnicos en todas las tareas, registra los productos que han utilizado y los costos en los que han incurrido.  
...
6. En la ficha desplegable **Comercio exterior**, defina el código de divisa en **USD**. Si selecciona USD en el campo **Código divisa factura**, el proyecto se factura en dólares estadounidenses y se planifica en la divisa local de CRONUS solamente.  

 Puede personalizar el precio para los clientes por cada proyecto, en función de los contratos que ha configurado. En el siguiente procedimiento, el director de proyectos especifica un costo para el tiempo de Tricia, define el precio del software correspondiente y suma los costos de viaje que el cliente ha acordado pagar.  
...
8. En la página **Precios de cuenta de proyecto**, introduzca la siguiente información y el costo de viaje, para el que el cliente ha acordado pagar el costo además del 25 %:  
...
2. Cree líneas de planificación con la siguiente información:  
    ...
    | 3    | Presupuesto y facturable | (fecha de hoy) | Cuenta de contabilidad | 8430 (viajes) | 2 | 400    |
...
A continuación, Tricia puede crear una factura nueva para el proyecto completo o para parte de un proyecto. Tricia también puede adjuntar la factura a otra factura para el mismo cliente y proyecto. En este caso, Tricia factura todo el proyecto, porque este ya se ha completado.  
...
Después de que Tricia cree la factura, está disponible en el área de tareas **Procesadora de órdenes de venta**, por ejemplo.
...
2. Seleccione una de las líneas de planificación que se han facturado y, a continuación, seleccione la acción **Factura de venta/nota de crédito**.
3. En la página **Facturas de proyecto**, elija la acción **Factura de venta/nota de crédito pendiente**.  

Tricia tiene una pregunta acerca de los precios, los costos y los beneficios correspondientes a este proyecto en particular; por lo tanto, Tricia accede a esa información en la página **Estadísticas**.  

### <a name="to-open-the-statistics-page"></a>Para abrir la página Estadísticas

1. Elija el icono ![Bombilla que abre la función Dígame.](media/ui-search/search_small.png "Dígame qué desea hacer") , escriba **Proyectos** y, a continuación, elija el vínculo relacionado.  
2. Seleccione la acción **Estadísticas**. Puede revisar la información detallada acerca de los precios, costos y beneficios del proyecto en las divisas local y extranjera.  
...
CRONUS se ha contratado a las salas de conferencias de instalación. Como director del proyecto, Prakash desea tener un buen panorama de las tareas que requiere el proyecto con los costos presupuestados e incurridos asociados de cada tarea. Además, Prakash desea conocer el precio contratado total del proyecto y el importe que se lleva facturado. Han llegado a un acuerdo con el cliente respecto del precio fijo del proyecto.  
...
3. Seleccione la línea 1120 y, en el campo **Presupuesto (costo total)**, haga clic con el botón derecho en el importe y seleccione **Análisis**.  
...
4. En la página **Líneas de tarea de proyecto**, seleccione la línea 1120 y, a continuación, elija la acción **Líneas de planificación de proyecto**. Cree una línea de planificación con la siguiente información:  
    ...
    | 1    | Presupuesto y facturable  | Recurso | Tricia | 30 |
     ...
     Cierre la página.  
5. En el campo **Presupuesto (costo total)**, haga clic con el botón secundario en el campo y elija **Análisis** otra vez en la página **Líneas tarea proyecto**. Vea los cambios a la programación. Puede ver que se han agregado 30 horas al programa.  
...
8. En la opción **Diario proyecto**, cree una línea nueva con la siguiente información. Asegúrese de que ambos números de proyecto son secuenciales con los que ha utilizado ya:  
    ...
    - **Cantidad**: **5**  
     ...
     Si utiliza el tipo de línea **Presupuesto**, se actualizan los costos y los precios previstos, pero no se actualizan los precios ni los costos del contrato que se facturan al cliente.  

9. Seleccione la acción **Registrar**. Elija el botón **Aceptar** para cerrar la página.  
10. Abra la lista **Proyectos**.  
11. Seleccione el proyecto GUILDFORD y, a continuación, en la sección **Líneas tarea proyecto**, seleccione la línea 1120 y en el campo **Presupuesto (costo total)**, haga clic con el botón derecho en el importe. Elija **Análisis** para ver la información.  

     Los cambios se introducen automáticamente en la línea para el N.º tarea de proyecto 1120 En el costo total del proyecto programado, se han agregado a la previsión cinco horas más de trabajo de Tricia.  
...
CRONUS acaba de iniciar un proyecto grande de un año de duración. Dado que requiere numerosos recursos, el director del proyecto configura el contrato de manera que el cliente pague la parte del precio por adelantado, otra parte cuando el proyecto esté por la mitad y el último pago tras su finalización.  
...
6. Cree una línea de planificación con la siguiente información:  
    ...
    | Línea | Tipo de línea | Fecha planif.  | Escriba        | Nº   | Cantidad | Precio unitario |
    |------|-----------|----------------|-------------|-------|----------|------------|
    | 1    | Facturable  | (fecha de hoy) | Cuenta de contabilidad | 40255 | 1        | 5000       |
...
10. Cree una línea de planificación con la siguiente información:
    ...
    | Línea | Tipo de línea | Fecha planif.   | Escriba        | Nº   | Cantidad | Precio unitario |
    |------|-----------|-----------------|-------------|-------|----------|------------|
    | 1    | Facturable  | (una fecha futura) | Cuenta de contabilidad | 40255 | 1        | 5000       |
