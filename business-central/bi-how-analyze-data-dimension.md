...
> [!TIP]
> Como una forma rápida de analizar datos transaccionales por dimensiones, puede filtrar por dimensiones los totales del catálogo de cuentas (COA) y movimientos en todas las páginas **Movimientos**. Busque la acción **Establecer filtro de dimensiones**.
...
> [!NOTE]  
> Puede utilizar el informe **Dimensiones - Detalles** para mostrar una clasificación detallada del uso de las dimensiones en los movimientos durante un periodo seleccionado. Utilice el informe **Dimensiones - Total** para ver sólo los importes totales.  
