...
description: 'Aprenda cómo obtener ayuda y soporte técnico para Business Central, incluido el chat con Copilot, consejos sobre el producto, el panel de ayuda, la página de ayuda y soporte técnico, la documentación del producto y los foros de la comunidad.'
author: brentholtorf
ms.author: bholtorf
...
Las organizaciones que usan [!INCLUDE[prod_long](includes/prod_long.md)] pueden recibir soporte técnico para cualquier problema que podrían experimentar. En este artículo, le mostramos la siguiente información y muchos otros consejos sobre cómo usar [!INCLUDE[prod_short](includes/prod_short.md)]:
...
- Utilizar el campo **Filtrar por título** en la tabla de contenido en el lado izquierdo del sitio web
  ...
  De esta manera, puede filtrar por palabras utilizadas en los títulos de los diversos artículos. Por ejemplo, escriba *factura*, y luego elija uno de los enlaces ofrecidos, como [Configurar el redondeo de facturas](finance-set-up-invoice-rounding.md) o [Crear facturas de anticipo](finance-how-to-create-prepayment-invoices.md).  
