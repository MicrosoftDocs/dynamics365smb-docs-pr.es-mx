...
ms.locfileid: "9607727"
---
# <a name="resources-for-help-and-support"></a>Recursos de ayuda y soporte técnico

Los consejos y la orientación sobre cómo usar [!INCLUDE[prod_long](includes/prod_long.md)], cómo desbloquearlo, dónde obtener más información y cómo encontrar información técnica están disponibles en [!INCLUDE [prod_short](includes/prod_short.md)]. Este artículo describe cómo encontrar qué.  
...
Si aún no tiene un socio, la comunidad también puede ayudarlo a resolver sus preguntas. Por ejemplo, si acaba de registrarse para una prueba, la comunidad puede ser un excelente punto de partida.  
