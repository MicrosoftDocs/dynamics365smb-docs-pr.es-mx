...
# Productos de inicio rápido de Business Central
...
A continuación, es el momento de introducir la información financiera de su empresa para que esté lista para hacer negocios. Para ahorrar tiempo, puede utilizar el catálogo de cuentas que [!INCLUDE[prod_short](includes/prod_short.md)] proporciona. Si lo necesita, puede personalizarlo en unos pocos pasos siguiendo [Inicio rápido de información financiera](quick-start-financial-information.md).
