...
- Recepciones de artículos cuando se cumplen los pedidos de compra.
...
### <a name="show-inventory-related-general-ledger-entries-and-balances-from-the-chart-of-accounts-page"></a>Mostrar los movimientos y balances de contabilidad general relacionados con el inventario desde la página del Catálogo de cuentas
...
Específicamente para administración de inventario, puede crear una vista en la página Catálogo de cuentas que solo muestre las cuentas que utiliza para registrar entradas de inventario.
