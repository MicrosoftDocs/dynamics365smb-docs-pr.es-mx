...
#### [Tutorial: elaboración de previsiones del flujo de caja con estructuras de cuentas](walkthrough-making-cash-flow-forecasts-by-using-account-schedules.md)
...
#### [Configure el mtto. de los activos fijos](fa-how-setup-maintenance.md)
...
##### [Procedimientos recomendados de configuración: políticas de reorden](setup-best-practices-reordering-policies.md)
...
##### [Uso de la extensión AMC Banking 365 Fundamentals](ui-extensions-amc-banking.md)
##### [Configurar el servicio de estado de cuenta bancario](bank-how-setup-bank-statement-service.md)
##### [Configurar bancos](bank-how-setup-bank-accounts.md)
...
#### [Concilie los pagos de clientes con el diario de recepción de efectivo o de los movimientos de cliente.](receivables-how-apply-sales-transactions-manually.md)
...
#### [Crear facturas de anticipos](finance-how-to-create-prepayment-invoices.md)
...
#### [Configuración de costos de inventario](finance-set-up-cost-accounting.md)
...
#### [Eliminar movs. ppto. costos](finance-how-to-delete-cost-budget-entries.md)

### Gestión de costos de inventario
#### [Información general de costo de inventario](finance-manage-inventory-costs.md)
#### [Acerca del contabilidad de inventario](finance-learn-about-costing.md)
#### [Usar los cargos de producto a cuenta para los costos comerciales adicionales](payables-how-assign-item-charges.md)
...
#### [Descripción del flujo de caja](finance-cash-flow-overview.md)
...
### [Tutorial: Configuración y facturación de anticipos de ventas](walkthrough-setting-up-and-invoicing-sales-prepayments.md)
### [Permite registrar nuevos clientes](sales-how-register-new-customers.md)
### [Crear cotizaciones de ventas](sales-how-make-offers.md)
...
### [Cotización de una venta de ensamblar para pedido](assembly-how-to-quote-an-assemble-to-order-sale.md)
...
### [Sobre los costos de la orden de producción terminada](finance-about-finished-production-order-costs.md)
...
#### [Realizar un picking de los artículos para la remisión de almacén](warehouse-how-to-pick-items-for-warehouse-shipment.md)
...
##### [Crear libros y secciones del libro diario de pagos](LocalFunctionality/Belgium/how-to-create-payment-journal-templates-and-batches.md)
...
##### [Estados de cuenta bancarios CODA](LocalFunctionality/Belgium/coda-bank-statements.md)
...
##### [Cerrar estado de cuentas de resultado](LocalFunctionality/France/how-to-close-income-statement-accounts.md)
...
##### [Valuación de inventario fiscal](LocalFunctionality/Italy/fiscal-inventory-valuation.MD)
##### [Configurar la valuación de inventario fiscal](LocalFunctionality/Italy/how-to-set-up-fiscal-inventory-valuation.md)
#### Activos fijos
...
##### [Configurar libros diario y secciones del mismo](LocalFunctionality/Italy/how-to-set-up-journal-templates-and-batches.md)
...
##### [Escenario de pago 3: pago al extranjero ($ a DE)](LocalFunctionality/Netherlands/payment-scenario-3-foreign-payment-lcy-to-fcy-.md)
...
#### Finanzas básicas
##### [Resumen de estructuras de cuentas](LocalFunctionality/Russia/account-schedules-overview.md)
##### [Importación y exportación de estructuras de cuentas](LocalFunctionality/Russia/How-to-Import-and-Export-Account-Schedules.md)
##### [Definición de una extensión de estructura de cuentas](LocalFunctionality/Russia/How-to-Define-an-Account-Schedule-Extension.md)
##### [Definición de una constante de estructura de cuentas](LocalFunctionality/Russia/How-to-Define-an-Account-Schedule-Constant.md)
##### [Trabajar con estructuras de cuentas](LocalFunctionality/Russia/How-to-Work-with-Account-Schedules.md)
...
##### [Configuración de empleados responsables y Estados de cuenta anticipados](LocalFunctionality/Russia/How-to-Set-Up-Responsible-Employees-and-Advance-Statements.md)
#### Pagos y cobros
...
##### [Configuración de anticipos de cliente](LocalFunctionality/Russia/how-to-set-up-customer-prepayments.md)
##### [Configuración de anticipos de proveedor](LocalFunctionality/Russia/how-to-set-up-vendor-prepayments.md)
##### [Registro de anticipos de proveedores y clientes](LocalFunctionality/Russia/prepayments-vendor-and-customers.md)
...
##### [Creación de una nota de crédito para un cargo de activo fijo](LocalFunctionality/Russia/How-to-Create-a-Credit-Memo-for-a-Fixed-Asset-Charge.md)
...
##### [IVA por anticipo de clientes](LocalFunctionality/Russia/VAT-by-Customer-prepayments.md)  
...
#### Finanzas básicas
##### [Configuración y cierre de estados de cuenta de resultado](LocalFunctionality/Spain/how-to-set-up-and-close-income-statement-balances.md)
##### [Indentar y validar el plan de cuentas](LocalFunctionality/Spain/how-to-indent-and-validate-chart-of-accounts.md)
...
##### [Exportar estructuras de cuentas a formato ASC](LocalFunctionality/Spain/how-to-export-account-schedules-to-asc-format.md)
...
##### [Imprimir informes de saldos y resultado](LocalFunctionality/Sweden/how-to-print-balance-sheet-and-income-statement-reports.md)  
...
#### [Ver productos de tránsito directo en un envío o una hoja de trabajo de picking](warehouse-how-to-cross-dock-items.md#to-view-cross-docked-items-in-a-shipment-or-pick-worksheet)
...
#### [Supervisión de costos de mantenimiento](fa-how-maintain.md#to-monitor-maintenance-costs)
...
#### [Información general sobre cotizaciones de servicio](service-how-to-allocate-resources.md#to-see-an-overview-of-service-orders-and-service-quotes)
