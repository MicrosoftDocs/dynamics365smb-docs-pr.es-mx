...
### Gestionar costos de inventario
...
#### [Sobre el cálculo costo unitario](finance-about-calculating-unit-cost.md)
...
#### [Configurar la valuación de inventarios y los costos](finance-set-up-inventory-valuation-and-costing.md)
...
#### Informar costos y conciliarlos con la contabilidad
##### [Informar costos](finance-report-costs-and-reconcile-with-the-general-ledger.md)
...
### [Tutorial: elaborar previsiones del flujo de caja con estructuras de cuentas](walkthrough-making-cash-flow-forecasts-by-using-account-schedules.md)
...
### [Introducción al conector Shopify](shopify/get-started.md)
