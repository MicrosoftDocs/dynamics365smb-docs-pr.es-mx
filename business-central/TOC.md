...
#### [Tutorial: usar informes financieros para elaborar previsiones de flujo de caja](walkthrough-making-cash-flow-forecasts-by-using-account-schedules.md)
...
##### [Configurar el servicio de estado de cuenta bancaria](bank-how-setup-bank-statement-service.md)
...
#### [Configurar contabilidad de costos](finance-set-up-cost-accounting.md)
...
#### [Crear presupuestos de costo](finance-create-cost-budgets.md)
#### [Eliminar movimientos de presupuesto de costos](finance-how-to-delete-cost-budget-entries.md)

### Administrar costos de inventario
#### [Información general de costos de inventario](finance-manage-inventory-costs.md)
#### [Acerca de los costos de inventario](finance-learn-about-costing.md)
#### [Usar los cargos de artículos a cuenta para los costos comerciales adicionales](payables-how-assign-item-charges.md)
#### [Acerca del cálculo del costo estándar](finance-about-calculating-standard-cost.md)
...
#### [Configurar la valuación de inventarios y costos](finance-set-up-inventory-valuation-and-costing.md)
#### [Revalorizar inventario](inventory-how-revalue-inventory.md)
#### [Ajustar costos de artículos](inventory-how-adjust-item-costs.md)
#### [Seguimiento de ajustes de costo de productos](finance-track-inventory-costs.md)
...
#### Notificar costos y conciliar con la contabilidad general
...
#### [Preparar estados de cuenta de cierre](year-prepare-close-statement.md)
#### [Cerrar periodos contables](year-close-account-periods.md)
#### [Cerrar cuentas de resultado](year-close-income-statement.md)
#### [Registrar el movimiento de cierre del ejercicio](year-how-post-year-end-close-entry.md)

### Trabajar con el catálogo de cuentas y la contabilidad general (C/G)
#### [Entender la contabilidad general y el catálogo de cuentas](finance-general-ledger.md)
...
#### [Analizar datos financieros del catálogo de cuentas](finance-general-ledger.md)
...
##### [Determinar el precio de venta por costo más porcentaje](LocalFunctionality/Australia/how-to-determine-sales-price-by-cost-plus-percentage.md)
...
##### [Crear lotes y libros diario de pagos](LocalFunctionality/Belgium/how-to-create-payment-journal-templates-and-batches.md)
...
##### [Estados de cuenta de banco CODA](LocalFunctionality/Belgium/coda-bank-statements.md)
##### [Liquidar estados de cuenta CODA](LocalFunctionality/Belgium/how-to-apply-coda-statements.md)
##### [Transferir y registrar automáticamente estados de cuenta CODA](LocalFunctionality/Belgium/how-to-automatically-transfer-and-post-coda-statements.md)
##### [Transferir y registrar manualmente estados de cuenta CODA](LocalFunctionality/Belgium/how-to-manually-transfer-and-post-coda-statements.md)
##### [Importar estados de cuenta CODA](LocalFunctionality/Belgium/how-to-import-coda-statements.md)
#### Finanzas básicas
...
##### [Hacer obligatorios los libros diario](LocalFunctionality/Belgium/specify-journal-template-mandatory.md)
...
##### [Estados de cuenta estatutarios](LocalFunctionality/Czech/statutory-statements.md)
...
##### [Devolución obligatoria del costo exacto en la fabricación](LocalFunctionality/Czech/how-to-setup-mandatory-return-exact-costs-manufacturing.md)
...
##### [Numeración de productos no inventariables](LocalFunctionality/Czech/how-to-setup-nonstock-item-numbering.md)
...
##### [Catálogo de cuentas público estándar en Dinamarca](LocalFunctionality/Denmark/how-to-set-up-standard-coa.md)
...
##### [Amortización de activos fijos](LocalFunctionality/India/FA_Depreciation.md)
#### Entrada
...
##### [Configurar lotes y libros diario](LocalFunctionality/Italy/how-to-set-up-journal-templates-and-batches.md)
...
##### [Escenario de pago 1: pagos nacionales ($ a $)](LocalFunctionality/Netherlands/payment-scenario-1-domestic-payments-lcy-to-lcy-.md)  
...
##### [Escenario de pago 3: pago al extranjero ($ a divisa extranjera)](LocalFunctionality/Netherlands/payment-scenario-3-foreign-payment-lcy-to-fcy-.md)
...
##### [Importar y conciliar estados de cuenta bancarios](LocalFunctionality/Netherlands/how-to-import-and-reconcile-bank-statements.md)
#### Finanzas básicas
...
##### [Editar importes de documento en facturas de compra y notas de crédito](LocalFunctionality/Netherlands/how-to-edit-document-amounts-in-purchase-invoices-and-credit-memos.md)  
...
##### [Ver notas de crédito de impuestos registradas](LocalFunctionality/NewZealand/how-to-view-posted-tax-credit-memos.md)  
...
##### [Calcular el impuesto sobre bienes y servicios sobre los anticipos](LocalFunctionality/NewZealand/how-to-calculate-goods-and-services-tax-on-prepayments.md)
...
#### Banca y pagos
##### [Comparar el flujo de caja bancario](LocalFunctionality/NewZealand/how-to-compare-bank-cash-flow.md)
...
##### [Imprimir estados de cuenta de ingresos](LocalFunctionality/NewZealand/how-to-print-income-statements.md)
#### General
##### [Direcciones](LocalFunctionality/NewZealand/addresses.md)
##### [Determinar el precio de venta por costo más porcentaje](LocalFunctionality/NewZealand/how-to-determine-sales-price-by-cost-plus-percentage.md)
...
##### [Configurar empleados responsables y estados de cuenta anticipados](LocalFunctionality/Russia/How-to-Set-Up-Responsible-Employees-and-Advance-Statements.md)
#### Cobros y pagos
...
##### [Configurar anticipos de clientes](LocalFunctionality/Russia/how-to-set-up-customer-prepayments.md)
##### [Configurar anticipos de proveedores](LocalFunctionality/Russia/how-to-set-up-vendor-prepayments.md)
##### [Registrar anticipos de proveedores y clientes](LocalFunctionality/Russia/prepayments-vendor-and-customers.md)
##### [Diferencias de anticipo](LocalFunctionality/Russia/prepayment-differences-invoices-prepayment-differences.md)
...
##### [Crear una nota de crédito para un cargo de activo fijo](LocalFunctionality/Russia/How-to-Create-a-Credit-Memo-for-a-Fixed-Asset-Charge.md)
...
##### [Cuenta para el costo por baja de activos fijos](LocalFunctionality/Russia/How-to-Account-for-the-Cost-to-Dispose-a-Fixed-Asset.md)
...
##### [IVA por anticipo de cliente](LocalFunctionality/Russia/VAT-by-Customer-prepayments.md)  
...
##### [SII - Tipos de factura y notas de crédito en documentos de compra y venta](LocalFunctionality/Spain/SII-invoice-types-sales-purchase-documents.md)
#### Finanzas básicas
##### [Configurar y cerrar estados de cuenta de ingresos](LocalFunctionality/Spain/how-to-set-up-and-close-income-statement-balances.md)
##### [Indentar y validar el catálogo de cuentas](LocalFunctionality/Spain/how-to-indent-and-validate-chart-of-accounts.md)
...
##### [Imprimir balance e informes de estado de cuenta de ingresos](LocalFunctionality/Sweden/how-to-print-balance-sheet-and-income-statement-reports.md)  
...
#### [Configurar el análisis de flujo de caja](finance-setup-cash-flow-analyses.md)
...
#### [Configurar la amortización de activos fijos](fa-how-setup-depreciation.md)
#### [Configurar métodos de amortización definidos por usuario](fa-how-setup-user-defined-depreciation-method.md)
#### [Configurar el seguro de activo fijo](fa-how-setup-insurance.md)
...
##### [Procedimientos recomendados de configuración: directivas de reorden](setup-best-practices-reordering-policies.md)
...
### [Obtener Business Central en el equipo de escritorio](install-desktop-app.md)
...
#### [Analizar estados de cuenta financieros con Excel](finance-analyze-excel.md)
...
#### [Análisis de flujo de caja](finance-setup-cash-flow-analyses.md)
...
#### [Supervisar costos de mantenimiento](fa-how-maintain.md#to-monitor-maintenance-costs)
...
#### [Información general de cotizaciones de servicio](service-how-to-allocate-resources.md#to-see-an-overview-of-service-orders-and-service-quotes)
...
#### [Detalles de diseño: cambio del método de costo para los productos](design-details-changing-costing-methods.md)
#### [Detalles de diseño: liquidación de productos](design-details-item-application.md)  
#### [Detalles de diseño: problema conocido con la liquidación de productos](design-details-inventory-zero-level-open-item-ledger-entries.md)  
#### [Detalles de diseño: ajuste de costo](design-details-cost-adjustment.md)  
#### Detalles de diseño: fecha de registro en el movimiento de valor de ajuste
