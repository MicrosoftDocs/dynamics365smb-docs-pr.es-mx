...
Aproveche la experiencia de colegas o expertos en la materia para superar obstáculos y minimizar el tiempo de inactividad. Cuando esté bloqueado por un error, puede compartir fácilmente los detalles del error cuando reciba ayuda. 
