...
description: Puede archivar órdenes de compra y venta, cotizaciones, órdenes de devolución y órdenes abiertas para poder usar el documento archivado para recrear el documento desde que se archivó.
author: SorenGP
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
...
Específicamente para el campo **Archivar cotizaciones**, la siguiente tabla describe la diferencia entre las opciones.

|Opción|Description|
|------|-----------|
|**Nunca**| Nunca archivar las cotizaciones de venta cuando se eliminan.|
|**Pregunta**|Seleccione solicitar al usuario que elija si desea archivar las cotizaciones de ventas cuando se eliminan.|
|**Siempre**|Seleccione archivar automáticamente las cotizaciones de venta cuando se eliminan.|
