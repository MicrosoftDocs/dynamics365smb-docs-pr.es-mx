...
A diferencia de las funciones de redondeo de facturas, las funciones de redondeo de importe y precio-producto solo afectan a los importes en divisas extranjeras, no a los importes correspondientes en $. Estas dos características no dan lugar a ningún registro en las cuentas de contabilidad. Como consecuencia, no es necesario especificar ninguna cuenta en los grupos contables ni en ninguna otra sección.
