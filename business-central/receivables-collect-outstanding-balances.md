...
## <a name="statements" />Estados de cuenta
...
### <a name="to-send-the-customer-statement-report" />Para enviar el informe Estado de cuenta de cliente
...
## <a name="finance-charges" />Intereses
