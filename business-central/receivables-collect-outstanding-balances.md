...
Tras crear notas de cobro de finanzas, puede modificarlas. El texto que aparecen al principio y al final de la nota de cobro de finanzas se determina según las condiciones de cobro de finanzas y se puede ver en la columna **Descripción** de las líneas. Si se ha insertado automáticamente una cantidad calculada en el texto inicial o final, el texto no se ajustará si elimina líneas. Para ello, deberá usar la función **Actualizar texto interés**.  
