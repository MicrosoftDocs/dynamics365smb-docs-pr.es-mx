...
|<name> |  2020-09-11      |2020-09-30      |
 ...
 Al asignar al usuario un intervalo de fechas de registro permitido más amplio (o el mismo) que en Período de inventario o Configuración de contabilidad general, se evitará el conflicto mencionado. El movimiento valor de ajuste con fecha de contabilización del 10 de septiembre se contabilizará correctamente con esta configuración.
...
![Costo real frente a costo previsto.](media/helene/TechArticleAdjustcost14.png "Costo real frente a costo esperado")
