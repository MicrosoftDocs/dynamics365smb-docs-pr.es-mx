...
2. En la dirección, ingrese la URL que usa para abrir Business Central y agregue `/connectivity` al final. 
    ...
    O bien, si la URL incluye el ID del inquilino, como  `https://businesscentral.dynamics.com/aaaabbbb-0000-cccc-1111-dddd2222eeee`, deberá ingresar lo siguiente:
