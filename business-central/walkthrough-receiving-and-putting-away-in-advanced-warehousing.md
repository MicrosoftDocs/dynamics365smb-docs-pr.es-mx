...
2.  Seleccione la acción **Nuevo**.  
3.  En el campo **Cód. almacén**, especifique BLANCO.  
4.  Seleccione **Acciones**, luego **Funciones** y, a continuación, seleccione la acción **Utiliz. filt. para tomar docs. or.**  
...
11. Elija **Registro**, la acción **Registrar recepción** y elija el botón **Sí**.  
