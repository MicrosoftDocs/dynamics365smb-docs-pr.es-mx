...
5. Compartir las impresoras con los usuarios.
    ...
    > [!TIP]
    > Siempre puede agregar o eliminar usuarios más tarde. Obtenga más información en [Configurar permisos de usuario para la impresora Compartir](/universal-print/reference/portal/share-printers#configure-user-permissions-for-a-printer-share).
...
6. Habilite la conversión de documentos.
    ...
    Obtenga más información en  [Descripción general de la conversión de documentos](/universal-print/reference/portal/settings#2-document-conversion).
