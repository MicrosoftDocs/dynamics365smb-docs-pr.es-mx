...
En caso de recuento manual, puede imprimir una lista, el informe **Registro inv. fís.**, que tiene una columna en blanco en la que los empleados pueden escribir las cantidades contadas. Una vez finalizado el recuento, introduzca las cantidades registradas en las líneas relacionadas de la página **Registro invent. fís.** Por último, transfiera las cantidades registradas al pedido de inventario físico relacionado definiendo el estado **Terminada**.
...
También puede elegir la acción **Dif. orden inventario fís.** para ver las diferencias entre la cantidad esperada y la cantidad contada.
...
* Use **Remisiones de inventario** para cancelar bienes perdidos o dañados.

Puede imprimir estos documentos en cualquier etapa, liberarlos y volver a abrirlos, y asignarles valores comunes como dimensiones en el encabezado. Para reimprimir los documentos después de su publicación, utilice las páginas **Recepción de inventario registrado** y **Envío de inventario registrado** .
...
- Elija las acciones **Lanzar** o **Volver a abrir** para establecer el estado de la siguiente etapa de procesamiento.  
