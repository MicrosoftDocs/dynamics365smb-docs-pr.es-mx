...
Puede imprimir estos documentos en cualquier etapa, liberarlos y volverlos a abrir, y asignar valores comunes, como dimensiones, en el encabezado. Para reimprimir los documentos después de su publicación, utilice las páginas **Recepción de inventario registrado** y **Envío de inventario registrado** .
