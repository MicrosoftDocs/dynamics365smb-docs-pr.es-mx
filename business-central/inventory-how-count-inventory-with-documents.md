...
> Tenga en cuenta que si utiliza la funcionalidad de zonas, no puede utilizar órdenes de inventario físico. En su lugar, utilice **Diario de inventario físico de almacén** para contar las entradas del almacén antes de sincronizarlas con las entradas del libro mayor de productos.
