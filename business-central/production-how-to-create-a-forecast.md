...
La funcionalidad de previsión de la aplicación se puede usar para crear previsiones de ventas o de producción, juntas o por separado. Por ejemplo, casi todas las empresas que fabrican contra orden no disponen de inventario de productos terminados, porque cada producto se fabrica cuando se pide. La previsión de pedidos (previsión de ventas) es esencial para lograr unos plazos de producción de los productos terminados razonables (previsión de producción). Por ejemplo, si las piezas de los componentes tienen tiempos de entrega muy largos, y no están pedidas o en inventario, pueden retrasar la producción.  
...
Considere este ejemplo: su empresa compra y vende artículos en dos ubicaciones: EAST y WEST. Para ambas ubicaciones, ha configurado una política de reorden de lote a lote. Crea una previsión para las dos ubicaciones:
