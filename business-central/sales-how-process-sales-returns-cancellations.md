...
|Función**Copiar líneas** en las páginas **Nota de crédito venta** y **Pedido dev. venta**.|Copia la cabecera y las líneas de un documento registrado que se revertirá.<br /><br /> Requiere que se active la casilla de verificación **Costo exacto devol. obligatorio** en la página **Configuración ventas y cobros**.|
