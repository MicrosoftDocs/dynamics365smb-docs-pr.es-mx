...
Puede negociar con el cliente creando primero una cotización venta que podrá convertir en una orden cuando acuerde la venta. Para obtener más información, consulte [Realización de ofertas](sales-how-make-offers.md).
...
15. Cuando haya completado la ficha cliente, haga clic en el botón **Aceptar** para volver a la ventana **Orden de venta**.

    Muchos campos dela orden de venta se rellenan con la información especificada en la nueva ficha de cliente.
16. Rellene los campos restantes de la ventana **Orden de venta** según sea necesario. [!INCLUDE[tooltip-inline-tip](includes/tooltip-inline-tip_md.md)]  
...
23. Para enviar únicamente una parte de la cantidad de la orden, escriba dicha cantidad en el campo **Cantidad a enviar**. El calor se copia en el campo **Cantidad a facturar**.
...
25. Cuando las líneas dela orden de venta ya estén completas, seleccione la acción **Registrar y enviar**.
