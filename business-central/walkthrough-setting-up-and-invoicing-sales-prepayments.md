...
Los anticipos son pagos que se facturan y registran en un pedido de anticipo de ventas o compras antes de la facturación final. Es posible que solicite un depósito antes de fabricar productos del pedido, o que solicite un pago antes de enviar productos al cliente. La funcionalidad de anticipos en [!INCLUDE[prod_short](includes/prod_short.md)] se utiliza para facturar y cobrar depósitos de los clientes o remitir depósitos a los proveedores. De este modo, puede asegurar que todos los pagos estén registrados contra una factura.  
...
4.  Seleccione **Relacionado**, **Ventas** y **Porcentajes de anticipo**
...
8.  En la ficha desplegable **Anticipo**, el campo de **Importe línea anticipo sin IVA** contiene **458.16**. Si ahora crea una factura de anticipo para el pedido, ésta será el importe que figura en la factura.  
...
2.  En la línea del producto **1896-S**, en el campo **Cantidad**, escriba **2**.  
    ...
    En la acción **Pedido**, elija **Estadísticas**. El campo de **Anticipo Excl de la línea importe. IVA** contiene ahora **768.04** y el campo **Importe anticipo facturado sin IVA** contiene **417.76**. Este campo muestra que hay un importe de anticipo adicional que aún no se ha facturado.  
...
4.  En la página **Movs. pendientes cliente**, seleccione la primera factura de anticipo, elija la acción **Procesar** y, después, seleccione **Marcar id. de liquidación**.  
