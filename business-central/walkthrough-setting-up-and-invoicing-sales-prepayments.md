...
ms.author: edupont
---
# <a name="walkthrough-setting-up-and-invoicing-sales-prepayments" />Tutorial: Configuración y facturación de anticipos de ventas
...
## <a name="set-up-prepayments" />Configurar anticipos
...
### <a name="to-set-up-number-series-for-prepayments" />Para configurar series numéricas para anticipos
...
### <a name="to-block-shipments-for-unpaid-prepayment" />Para bloquear envíos por anticipos sin abonar
...
### <a name="to-assign-default-prepayment-percentages-to-customers-and-items" />Para asignar porcentajes de anticipo predeterminados a clientes y productos
...
### <a name="to-specify-an-account-for-sales-prepayments-in-general-posting-setup" />Para especificar una cuenta para los anticipos de ventas en la configuración del registro general
...
## <a name="create-an-order-that-requires-a-prepayment" />Crear una orden que requiera un anticipo
...
### <a name="to-create-a-sales-order-with-a-prepayment" />Para crear un pedido de venta con anticipo
...
## <a name="create-a-prepayment-invoice" />Crear una factura de anticipo
...
## <a name="create-an-additional-prepayment-invoice" />Crear una factura de anticipo adicional
...
### <a name="to-create-an-additional-prepayment-invoice" />Para crear una factura de anticipo adicional
...
## <a name="apply-the-prepayments" />Aplicar los anticipos
...
### <a name="to-apply-a-payment-to-the-prepayment-invoices" />Para aplicar un pago a las facturas de anticipo
