...
---
# <a name="walkthrough-set-up-and-invoicing-sales-prepayments"></a>Tutorial: Configurar y facturar anticipos de ventas
...
## <a name="create-an-order-that-requires-a-prepayment"></a>Crear un pedido que requiera un anticipo
