...
Además de las formas estándar de crear los almacenamientos de almacén que se describen en este artículo, puede crear los almacenamientos desde la recepción de almacén registrada relacionada. Esta acción es útil si tiene líneas de almacenamiento eliminadas o si decide no utilizar la hoja de trabajo de almacenamiento, porque puede crear o volver a crear las instrucciones de almacenamiento desde líneas del histórico de recepciones.
...
Puede crear documentos de almacenamiento para varias recepciones al mismo tiempo en la página **Hoja trabajo ubicación**.  

1. Elija el icono ![Bombilla que abre la función Dígame.](media/ui-search/search_small.png "Dígame qué desea hacer") , escriba **Hojas de trabajo de almacenamientos** y luego elija el enlace relacionado.  
2. Seleccione la acción **Tomar documentos almacén**. Se abre la página **Selección ubicación**.  

    La lista contiene todo el histórico de recepciones que están listas para el almacenamiento, incluidas aquellas para las que ya se han creado instrucciones de almacenamiento. Los documentos con líneas de ubicación que ya se han ubicado y registrado completamente no se muestran en la lista.  
...
Si un almacén usa el procesamiento de almacenamiento y de recepción y ha eliminado las líneas de almacenamiento, o si utiliza almacenamiento y picking dirigidos y ha decidido no utilizar la hoja de trabajo de almacenamiento, puede crear o volver a crear las instrucciones de almacenamiento para líneas del histórico de recepciones.

1. Elija el icono ![Bombilla que abre la función Dígame.](media/ui-search/search_small.png "Dígame qué desea hacer") , escriba **Recepciones de almacenamiento registradas** y, a continuación, elija el vínculo relacionado.  
2. Seleccione un histórico de recepciones para ubicar.  
...
1. Elija el icono ![Bombilla que abre la función Dígame.](media/ui-search/search_small.png "Dígame qué desea hacer") , escriba **Almacenamientos de almacén** y luego elija el enlace relacionado.
