...
description: Obtenga información sobre cómo configurar su catálogo de cuentas (COA) para mostrar las cuentas de contabilidad que almacenan sus datos financieros.
author: brentholtorf
ms.author: bholtorf
ms.reviewer: bnielse
ms.topic: conceptual
