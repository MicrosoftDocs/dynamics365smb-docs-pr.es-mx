...
ms.author: bholtorf
---
# <a name="analyzing-cash-flow-in-your-company" />Analizar el flujo de caja de la empresa
...
## <a name="to-view-a-cash-flow-worksheet" />Para ver la hoja de flujo de caja
