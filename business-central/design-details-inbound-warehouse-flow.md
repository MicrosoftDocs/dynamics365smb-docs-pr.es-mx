...
En una configuración de almacén avanzada, el interruptor **Requerir recepción** está activado en la página Tarjeta de ubicación para la ubicación. El conmutador **Ubicación requerida** es opcional.
...
Obtenga las líneas de ubicación del almacén en la **Hoja de trabajo de ubicación** basándose en las recepciones de almacén registrados o en las operaciones que generan resultados. Elija las líneas para ubicar y especifique la siguiente información:
...
|**Para**|**Vea**|  
|------------|-------------|  
|Registre la recepción de productos en las ubicaciones del almacén o con una recepción de almacén, en caso de procesamiento semi o totalmente automatizado del almacén en la ubicación.|[Recibir productos](warehouse-how-receive-items.md)|
