---
title: Copiar datos a una nueva empresa
description: Si utiliza RapidStart Services, puede copiar los valores de uso general de una empresa existente a otra nueva, siempre y cuando ambas empresas estén en la misma base de datos.
author: SorenGP
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
...
ms.locfileid: "8518374"
---
# <a name="copy-data-to-new-companies-with-rapidstart-services"></a>Copiar datos a una nueva empresa con RapidStart Services
