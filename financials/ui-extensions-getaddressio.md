---
title: "Códigos postales de Reino Unido de GetAddress.io | Documentos de Microsoft"
description: "Proporciona información sobre la extensión Códigos postales de Reino Unido de GetAddress.io"
...
1. En **Dirección**, elija **Buscar dirección a partir del código postal**.  
    ...
    **NOTA**: La opción **Buscar dirección a partir del código postal** solo está disponible si el campo **Cód. país/región** está vacío o contiene **GB**.
...
3. En la ventana **Selección de dirección**, elija la dirección.  
    ...
    **SUGERENCIA**: Si sabe el número de calle, puede filtrar las direcciones introducir el número completo o parte de él en el campo **Punto de entrega**.
