...
|**Para**|**Vea**|  
|------------|-------------|  
|Agregar usuarios, gestionar permisos y gestionar el acceso a los datos, asignar roles.|[Usuarios, perfiles y áreas de tareas en Finance and Operations, Business edition](admin-users-profiles-roles.md)|  
