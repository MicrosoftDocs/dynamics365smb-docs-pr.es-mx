...
A diferencia de los movimientos que se registran con documentos, que requieren un proceso de nota de crédito, puede revertir correctamente los movimientos que se registran con el diario general. Para obtener más información, consulte [Revertir un registro de diario](finance-how-reverse-journal-posting.md).
