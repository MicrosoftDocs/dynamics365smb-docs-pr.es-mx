---
title: Ajustar inventario| Documentos de Microsoft
...
---
# <a name="how-to-adjust-inventory"></a>Ajuste de inventario
...
**Nota**: Una vez que haya ajustado el inventario, debe actualizarlo con el valor calculado actual. Para obtener más información, vea [Revaluación de inventario](inventory-how-revalue-inventory.md).

También puede usar la función como una manera sencilla de incluir los productos comprados en el inventario si no usa la ventana **Factura de compra** para registrar las compras. Para obtener más información, consulte [Procedimiento: Registrar compras](purchasing-how-record-purchases.md).

## <a name="to-adjust-an-items-quantity-on-inventory"></a>Para ajustar la cantidad de un producto en el inventario
