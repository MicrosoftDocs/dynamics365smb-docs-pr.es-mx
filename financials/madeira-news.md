...
- Ahora puede configurar productos no inventariables, productos que desea ofrecer a los clientes, pero que no desea mantener en el inventario. Para obtener más información, consulte [Trabajar con productos sin stock](inventory-how-work-nonstock-items.md).
