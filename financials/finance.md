---
title: Finanzas | Documentos de Microsoft
description: "Obtenga información sobre los procesos y conceptos financieros clave "
...
| Obtenga información sobre la contabilidad y el catálogo de cuentas. |[Libro mayor y plan de cuentas](finance-general-ledger.md) |
| Agregue dimensiones para la inteligencia empresarial más completa. |[Dimensiones](finance-dimensions.md) |
| Use estructuras de cuentas para obtener información detallada de sus datos financieros. |[Esquemas de cuentas](finance-account-schedule.md) |
...
| Abra un año fiscal. |[Abrir un nuevo ejercicio](finance-how-open-new-fiscal-year.md) |
...
| Canadá: Configurar y usar códigos GIFI para informes financieros. |[Trabajar con los códigos GIFI en Canadá](ca-finance-work-gifi-codes.md) |
