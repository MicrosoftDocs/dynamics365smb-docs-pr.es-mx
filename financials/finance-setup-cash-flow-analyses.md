...
3. Seleccione el icono ![Buscar página o informe](media/ui-search/search_small.png "icono Buscar página o informe"), especifique **Previsión de flujo de caja** y elija el vínculo relacionado.
4. En la ventana **Previsión de flujo de caja**, seleccione la acción **Recalcular previsión**.  
