...
|Saldo|El importe registrado en la cuenta de la línea se distribuirá entre las cuentas especificadas para dicha línea en la tabla Diario gen. distribución. El saldo de la cuenta será por lo tanto cero. No olvide rellenar el campo **% Distribución** en la ventana **Asignaciones**. Para obtener más información, consulte la sección "Asignación de importes de diario recurrentes a varias cuentas".|
